...
class_name Quest_side_quest_1_brother_gareth

var quest_data: Dictionary = {'id': 'side_quest_1_brother_gareth', 'title': 'Personal Favor', 'description': 'Brother Gareth needs help with a personal matter.', 'summary': 'Help Brother Gareth with personal favor', 'giver_npc': 'Brother Gareth', 'objectives': [{'id': 'side_quest_1_obj_1', 'description': 'Listen to the problem', 'type': 'talk_to_npc', 'target': 'Brother Gareth', 'quantity': 1, 'optional': False, 'prerequisites': None}, {'id': 'side_quest_1_obj_2', 'description': 'Help solve it', 'type': 'talk_to_npc', 'target': 'Brother Gareth', 'quantity': 1, 'optional': False, 'prerequisites': None}, {'id': 'side_quest_1_obj_3', 'description': 'Return for thanks', 'type': 'talk_to_npc', 'target': 'Brother Gareth', 'quantity': 1, 'optional': False, 'prerequisites': None}], 'rewards': {'experience': 77, 'gold': 32, 'items': ['Thank You Gift'], 'relationship_changes': None}, 'prerequisites': None, 'level_requirement': 1, 'estimated_duration': '15-30 minutes', 'quest_type': 'side', 'interconnected_quests': ['main_quest_2_sister_fiona'], 'narrative_importance': 'low'}
