...
# Style Parameters: {'shape': 'round', 'density': 'medium', 'leaf_size': 'large', 'flowering': 'none', 'berry_type': 'none', 'thorns': 'light'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_111604_create_a_medivial_game/ai_creative_assets/ai_textures/foliage_medieval_6e1cf667.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.1523278720922434
WIDTH_MULT = 1.2917841266861971
COMPLEXITY = "simple"
DETAIL_COUNT = 2
ASYMMETRY = 0.22193597555791297
...
try:
    ...
    print(f"🎨 Style: {'shape': 'round', 'density': 'medium', 'leaf_size': 'large', 'flowering': 'none', 'berry_type': 'none', 'thorns': 'light'}")
