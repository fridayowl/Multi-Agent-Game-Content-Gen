...
# Style Parameters: {'shape': 'flat', 'surface': 'rough', 'size_category': 'boulder', 'formation': 'pile', 'weathering': 'eroded', 'mineral_type': 'granite'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_111604_create_a_medivial_game/ai_creative_assets/ai_textures/stone_medieval_1bc90494.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.620518538073686
WIDTH_MULT = 1.2268710073589733
COMPLEXITY = "simple"
DETAIL_COUNT = 5
ASYMMETRY = 0.12368818602745753
...
try:
    ...
    print(f"🎨 Style: {'shape': 'flat', 'surface': 'rough', 'size_category': 'boulder', 'formation': 'pile', 'weathering': 'eroded', 'mineral_type': 'granite'}")
