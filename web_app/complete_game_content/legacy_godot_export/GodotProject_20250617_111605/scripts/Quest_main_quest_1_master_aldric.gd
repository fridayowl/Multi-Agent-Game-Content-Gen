...
class_name Quest_main_quest_1_master_aldric

var quest_data: Dictionary = {'id': 'main_quest_1_master_aldric', 'title': 'The Village Crisis', 'description': 'Master Aldric needs help resolving a crisis that threatens the village.', 'summary': 'Help Master Aldric with the village crisis', 'giver_npc': 'Master Aldric', 'objectives': [{'id': 'main_quest_1_obj_1', 'description': 'Investigate the problem', 'type': 'investigate', 'target': 'location', 'quantity': 1, 'optional': False, 'prerequisites': None}, {'id': 'main_quest_1_obj_2', 'description': 'Gather information from villagers', 'type': 'investigate', 'target': 'location', 'quantity': 1, 'optional': False, 'prerequisites': None}, {'id': 'main_quest_1_obj_3', 'description': 'Find a solution', 'type': 'investigate', 'target': 'location', 'quantity': 1, 'optional': False, 'prerequisites': None}, {'id': 'main_quest_1_obj_4', 'description': 'Report back', 'type': 'investigate', 'target': 'Master Aldric', 'quantity': 1, 'optional': False, 'prerequisites': None}], 'rewards': {'experience': 156, 'gold': 65, 'items': ['Quest Item 1'], 'relationship_changes': None}, 'prerequisites': None, 'level_requirement': 1, 'estimated_duration': '15-30 minutes', 'quest_type': 'main', 'interconnected_quests': [], 'narrative_importance': 'high'}
