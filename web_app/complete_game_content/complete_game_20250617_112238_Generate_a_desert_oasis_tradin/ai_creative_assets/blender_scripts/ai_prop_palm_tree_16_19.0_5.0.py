...
# Style Parameters: {'trunk_style': 'curved', 'canopy_shape': 'palm_fronds', 'branch_density': 'sparse', 'leaf_type': 'palm', 'seasonal_state': 'autumn', 'bark_texture': 'rough', 'height_variation': 'giant'}
...
# AI Texture paths
ai_textures = {"bark": "complete_game_content/complete_game_20250617_112238_Generate_a_desert_oasis_tradin/ai_creative_assets/ai_textures/wood_desert_7e6238ae.png", "leaves": "complete_game_content/complete_game_20250617_112238_Generate_a_desert_oasis_tradin/ai_creative_assets/ai_textures/foliage_desert_74fbb628.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.4280665650238689
WIDTH_MULT = 1.1438447533648417
COMPLEXITY = "complex"
DETAIL_COUNT = 3
ASYMMETRY = 0.34686207960376114
...
def create_ai_unique_palm_tree():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_palm_tree_16"
...
def create_ai_tree():
    ...
    if trunk_style == "twisted":
        ...
        for i in range(max(2, DETAIL_COUNT // 2)):
            ...
            segment.name = f"AI_twisted_segment_{i}_16"
        ...
        trunk.name = f"AI_gnarled_trunk_16"
        ...
        for i in range(2):
            ...
            branch.name = f"AI_split_branch_{i}_16"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_straight_trunk_16"
        tree_parts.append(trunk)
    ...
    if canopy_shape == "round":
        ...
        canopy.name = f"AI_round_canopy_16"
        ...
        canopy.name = f"AI_oval_canopy_16"
        tree_parts.append(canopy)
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere.name = f"AI_irregular_canopy_{i}_16"
        ...
        for i in range(cluster_count):
            ...
            cluster.name = f"AI_sparse_cluster_{i}_16"
        ...
        for i in range(frond_count):
            ...
            frond.name = f"AI_palm_frond_{i}_16"
        ...
        canopy = bpy.context.active_object
        canopy.name = f"AI_default_canopy_16"
        tree_parts.append(canopy)
...
def create_ai_rock():
    ...
    if rock_shape == "angular":
        ...
        for i in range(DETAIL_COUNT // 2):
            ...
            crystal.name = f"AI_crystal_{i}_16"
    ...
    rock.name = f"AI_rounded_rock_16"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere = bpy.context.active_object
            sphere.name = f"AI_spreading_bush_{i}_16"
...
def create_ai_generic_prop():
    ...
    prop.name = f"AI_generic_prop_16"
...
try:
    ...
    print(f"🎨 Style: {'trunk_style': 'curved', 'canopy_shape': 'palm_fronds', 'branch_density': 'sparse', 'leaf_type': 'palm', 'seasonal_state': 'autumn', 'bark_texture': 'rough', 'height_variation': 'giant'}")
