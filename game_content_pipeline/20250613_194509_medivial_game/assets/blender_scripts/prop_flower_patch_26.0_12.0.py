...
if "flower_patch" == "bush":
    ...
    for i in range(3):
        ...
        bpy.ops.mesh.primitive_ico_sphere_add(
            subdivisions=2,
            radius=radius,
            location=(26.0 + offset_x, 12.0 + offset_y, 0.5 + offset_z)
        )
    ...
    prop.name = "Enhanced_Bush_26.0_12.0"
    ...
    for i in range(8):
        ...
        bpy.ops.mesh.primitive_ico_sphere_add(
            subdivisions=1,
            radius=0.05,
            location=(26.0 + x_offset, 12.0 + y_offset, 0.15)
        )
    ...
    prop = bpy.context.active_object
    prop.name = "Enhanced_FlowerPatch_26.0_12.0"
    ...
    bpy.ops.mesh.primitive_cube_add(location=(26.0, 12.0, 0.5))
    prop = bpy.context.active_object
    prop.name = "Enhanced_flower_patch_26.0_12.0"
