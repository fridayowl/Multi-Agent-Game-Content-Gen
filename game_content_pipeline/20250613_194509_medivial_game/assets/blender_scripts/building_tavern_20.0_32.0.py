...
# Texture paths
textures = {"walls": "textures/wood_medieval_874187e1.png", "roof": "textures/stone_medieval_8ceb7274.png"}

# Create tavern
bpy.ops.mesh.primitive_cube_add(
    size=1,
    location=(20.0, 32.0, 0.0)
)

building = bpy.context.active_object
building.name = "tavern_20.0_32.0"
building.scale = (12, 10, 6)
...
elif "tavern" == "blacksmith":
    # Add chimney for blacksmith
    bpy.ops.mesh.primitive_cylinder_add(
        radius=0.5,
        depth=3,
        location=(24.0, 32.0, 7.5)
    )
...
if "walls" in textures:
    wall_material = create_material_with_texture("medieval_tavern_walls", textures["walls"], base_color)
    building.data.materials.append(wall_material)
elif "roof" in textures:
    roof_material = create_material_with_texture("medieval_tavern_roof", textures["roof"], base_color)
    building.data.materials.append(roof_material)
else:
    # Fallback material
    material = bpy.data.materials.new(name="medieval_tavern")
    material.use_nodes = True
