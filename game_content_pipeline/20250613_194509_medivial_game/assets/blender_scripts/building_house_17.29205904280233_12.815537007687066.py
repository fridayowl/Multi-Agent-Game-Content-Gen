...
bpy.ops.mesh.primitive_cube_add(
    size=1,
    location=(17.29205904280233, 12.815537007687066, 0.0)
)

building = bpy.context.active_object
building.name = "house_17.29205904280233_12.815537007687066"
...
if "house" == "church":
    ...
    bpy.ops.mesh.primitive_cube_add(
        size=1,
        location=(17.29205904280233, 15.815537007687066, 2.5)
    )
    ...
    bpy.ops.mesh.primitive_cylinder_add(
        radius=0.5,
        depth=3,
        location=(19.958725709468997, 12.815537007687066, 6.5)
    )
