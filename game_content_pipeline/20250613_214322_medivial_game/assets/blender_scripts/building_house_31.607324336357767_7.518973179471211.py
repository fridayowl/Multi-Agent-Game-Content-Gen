...
bpy.ops.mesh.primitive_cube_add(
    size=1,
    location=(31.607324336357767, 7.518973179471211, 0.0)
)

building = bpy.context.active_object
building.name = "house_31.607324336357767_7.518973179471211"
...
if "house" == "church":
    ...
    bpy.ops.mesh.primitive_cube_add(
        size=1,
        location=(31.607324336357767, 10.51897317947121, 2.5)
    )
    ...
    bpy.ops.mesh.primitive_cylinder_add(
        radius=0.5,
        depth=3,
        location=(34.273991003024435, 7.518973179471211, 6.5)
    )
