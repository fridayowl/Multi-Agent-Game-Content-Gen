...
bpy.ops.mesh.primitive_cube_add(
    size=1,
    location=(29.376074265711253, 14.021518919667251, 0.0)
)

building = bpy.context.active_object
building.name = "house_29.376074265711253_14.021518919667251"
...
if "house" == "church":
    ...
    bpy.ops.mesh.primitive_cube_add(
        size=1,
        location=(29.376074265711253, 17.02151891966725, 2.5)
    )
    ...
    bpy.ops.mesh.primitive_cylinder_add(
        radius=0.5,
        depth=3,
        location=(32.04274093237792, 14.021518919667251, 6.5)
    )
