...
for i, angle in enumerate([0, 1.57, 3.14, 4.71]):  # 90 degree intervals
    ...
    bpy.ops.mesh.primitive_cylinder_add(
        radius=0.08,
        depth=2.5,
        location=(29.0 + x_offset, 4.0 + y_offset, 2.25)
    )
...
well.name = "Enhanced_Well_29.0_4.0"
