...
# Texture paths
textures = {"walls": "textures/wood_medieval_6e71f99b.png", "roof": "textures/stone_medieval_de1d7562.png"}
...
building.name = "market_20_20"
building.scale = (20, 15, 4)
...
elif "market" == "blacksmith":
    # Add chimney for blacksmith
    bpy.ops.mesh.primitive_cylinder_add(
        radius=0.5,
        depth=3,
        location=(26.666666666666668, 20, 5.5)
    )
...
if "walls" in textures:
    wall_material = create_material_with_texture("medieval_market_walls", textures["walls"], base_color)
    building.data.materials.append(wall_material)
elif "roof" in textures:
    roof_material = create_material_with_texture("medieval_market_roof", textures["roof"], base_color)
    building.data.materials.append(roof_material)
else:
    # Fallback material
    material = bpy.data.materials.new(name="medieval_market")
    material.use_nodes = True
