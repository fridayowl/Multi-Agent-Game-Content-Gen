...
# Style Parameters: {'construction': 'metal', 'roof_style': 'none', 'bucket_system': 'rope', 'water_level': 'high', 'decoration': 'ivy_covered', 'age': 'ancient'}
...
# AI Texture paths
ai_textures = {"stone": "game_content_pipeline/20250615_122733_medivial_game/ai_creative_assets/ai_textures/stone_medieval_76167108.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.386164272687926
WIDTH_MULT = 1.1517134495265267
COMPLEXITY = "medium"
DETAIL_COUNT = 4
ASYMMETRY = 0.11062751790989872
...
try:
    ...
    print(f"🎨 Style: {'construction': 'metal', 'roof_style': 'none', 'bucket_system': 'rope', 'water_level': 'high', 'decoration': 'ivy_covered', 'age': 'ancient'}")
