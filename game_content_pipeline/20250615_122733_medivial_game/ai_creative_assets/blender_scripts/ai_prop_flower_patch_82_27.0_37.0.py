...
# Prop #83: flower_patch
# AI Description: A unique medieval flower_patch with distinctive characteristics
# Style Parameters: {'shape': 'angular', 'size': 'medium', 'texture': 'detailed', 'color_scheme': 'natural', 'complexity': 'simple'}
...
# AI Texture paths
ai_textures = {"surface": "game_content_pipeline/20250615_122733_medivial_game/ai_creative_assets/ai_textures/generic_medieval_2b0518b3.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.1382156877903271
WIDTH_MULT = 1.2832394223798802
COMPLEXITY = "simple"
DETAIL_COUNT = 5
ASYMMETRY = 0.1379881718537313
...
def create_ai_unique_flower_patch():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_flower_patch_82"
...
def create_ai_rock():
    ...
    rock.name = f"AI_angular_rock_82"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_angular_bush_82"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'angular', 'size': 'medium', 'texture': 'detailed', 'color_scheme': 'natural', 'complexity': 'simple'}")
