...
bpy.ops.mesh.primitive_cube_add(
    size=1,
    location=(27.74460387238897, 25.701747378893323, 0.0)
)

building = bpy.context.active_object
building.name = "house_27.74460387238897_25.701747378893323"
...
if "house" == "church":
    ...
    bpy.ops.mesh.primitive_cube_add(
        size=1,
        location=(27.74460387238897, 28.701747378893323, 2.5)
    )
    ...
    bpy.ops.mesh.primitive_cylinder_add(
        radius=0.5,
        depth=3,
        location=(30.41127053905564, 25.701747378893323, 6.5)
    )
