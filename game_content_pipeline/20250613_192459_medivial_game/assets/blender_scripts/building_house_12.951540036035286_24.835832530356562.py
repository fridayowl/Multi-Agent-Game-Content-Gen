...
bpy.ops.mesh.primitive_cube_add(
    size=1,
    location=(12.951540036035286, 24.835832530356562, 0.0)
)

building = bpy.context.active_object
building.name = "house_12.951540036035286_24.835832530356562"
...
if "house" == "church":
    ...
    bpy.ops.mesh.primitive_cube_add(
        size=1,
        location=(12.951540036035286, 27.835832530356562, 2.5)
    )
    ...
    bpy.ops.mesh.primitive_cylinder_add(
        radius=0.5,
        depth=3,
        location=(15.618206702701952, 24.835832530356562, 6.5)
    )
