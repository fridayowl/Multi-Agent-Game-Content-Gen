...
# Texture paths  
textures = {"foliage": "textures/generic_medieval_516ad02f.png"}

# Create enhanced flower_patch
if "flower_patch" == "bush":
    ...
    for i in range(3):
        ...
        bpy.ops.mesh.primitive_ico_sphere_add(
            subdivisions=2,
            radius=radius,
            location=(13.0 + offset_x, 16.0 + offset_y, 0.5 + offset_z)
        )
    ...
    prop.name = "Enhanced_Bush_13.0_16.0"
...
elif "flower_patch" == "flower_patch":
    # Create ground patch
    bpy.ops.mesh.primitive_cylinder_add(
        vertices=16,
        radius=1.0,
        depth=0.1,
        location=(13.0, 16.0, 0.05)
    )
    ...
    for i in range(8):
        ...
        bpy.ops.mesh.primitive_ico_sphere_add(
            subdivisions=1,
            radius=0.05,
            location=(13.0 + x_offset, 16.0 + y_offset, 0.15)
        )
    ...
    prop = bpy.context.active_object
    prop.name = "Enhanced_FlowerPatch_13.0_16.0"
    ...
    bpy.ops.mesh.primitive_cube_add(location=(13.0, 16.0, 0.5))
    prop = bpy.context.active_object
    prop.name = "Enhanced_flower_patch_13.0_16.0"
    ...
    # Generic material
    material = bpy.data.materials.new(name="medieval_flower_patch")
    material.use_nodes = True
    bsdf = material.node_tree.nodes["Principled BSDF"]
