...
bpy.ops.mesh.primitive_cube_add(
    size=1,
    location=(22.357839184350603, 13.313023327487848, 0.0)
)

building = bpy.context.active_object
building.name = "house_22.357839184350603_13.313023327487848"
...
if "house" == "church":
    ...
    bpy.ops.mesh.primitive_cube_add(
        size=1,
        location=(22.357839184350603, 16.313023327487848, 2.5)
    )
    ...
    bpy.ops.mesh.primitive_cylinder_add(
        radius=0.5,
        depth=3,
        location=(25.02450585101727, 13.313023327487848, 6.5)
    )
