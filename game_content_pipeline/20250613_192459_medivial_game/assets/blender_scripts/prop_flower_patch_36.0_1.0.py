...
if "flower_patch" == "bush":
    ...
    for i in range(3):
        ...
        bpy.ops.mesh.primitive_ico_sphere_add(
            subdivisions=2,
            radius=radius,
            location=(36.0 + offset_x, 1.0 + offset_y, 0.5 + offset_z)
        )
    ...
    prop.name = "Enhanced_Bush_36.0_1.0"
    ...
    for i in range(8):
        ...
        bpy.ops.mesh.primitive_ico_sphere_add(
            subdivisions=1,
            radius=0.05,
            location=(36.0 + x_offset, 1.0 + y_offset, 0.15)
        )
    ...
    prop = bpy.context.active_object
    prop.name = "Enhanced_FlowerPatch_36.0_1.0"
    ...
    bpy.ops.mesh.primitive_cube_add(location=(36.0, 1.0, 0.5))
    prop = bpy.context.active_object
    prop.name = "Enhanced_flower_patch_36.0_1.0"
