...
bpy.ops.mesh.primitive_cube_add(
    size=1,
    location=(25.681010512480427, 17.480814896636154, 0.0)
)

building = bpy.context.active_object
building.name = "house_25.681010512480427_17.480814896636154"
...
if "house" == "church":
    ...
    bpy.ops.mesh.primitive_cube_add(
        size=1,
        location=(25.681010512480427, 20.480814896636154, 2.5)
    )
    ...
    bpy.ops.mesh.primitive_cylinder_add(
        radius=0.5,
        depth=3,
        location=(28.347677179147095, 17.480814896636154, 6.5)
    )
