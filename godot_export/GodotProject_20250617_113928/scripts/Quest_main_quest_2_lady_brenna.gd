...
class_name Quest_main_quest_2_lady_brenna

var quest_data: Dictionary = {'id': 'main_quest_2_lady_brenna', 'title': 'Ancient Secrets', 'description': 'Lady Brenna has discovered something that could change everything.', 'summary': 'Help Lady Brenna with ancient secrets', 'giver_npc': 'Lady Brenna', 'objectives': [{'id': 'main_quest_2_obj_1', 'description': 'Learn about the discovery', 'type': 'investigate', 'target': 'location', 'quantity': 1, 'optional': False, 'prerequisites': None}, {'id': 'main_quest_2_obj_2', 'description': 'Search for more clues', 'type': 'investigate', 'target': 'location', 'quantity': 1, 'optional': False, 'prerequisites': None}, {'id': 'main_quest_2_obj_3', 'description': 'Uncover the truth', 'type': 'investigate', 'target': 'location', 'quantity': 1, 'optional': False, 'prerequisites': None}, {'id': 'main_quest_2_obj_4', 'description': 'Decide what to do', 'type': 'investigate', 'target': 'location', 'quantity': 1, 'optional': False, 'prerequisites': None}], 'rewards': {'experience': 312, 'gold': 130, 'items': [], 'relationship_changes': None}, 'prerequisites': ['main_quest_1_sir_edwin'], 'level_requirement': 2, 'estimated_duration': '15-30 minutes', 'quest_type': 'main', 'interconnected_quests': [], 'narrative_importance': 'high'}
