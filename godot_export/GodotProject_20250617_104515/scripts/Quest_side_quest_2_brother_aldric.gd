...
class_name Quest_side_quest_2_brother_aldric

var quest_data: Dictionary = {'id': 'side_quest_2_brother_aldric', 'title': 'Personal Favor', 'description': 'Brother Aldric needs help with a personal matter.', 'summary': 'Help Brother Aldric with personal favor', 'giver_npc': 'Brother Aldric', 'objectives': [{'id': 'side_quest_2_obj_1', 'description': 'Listen to the problem', 'type': 'talk_to_npc', 'target': 'Brother Aldric', 'quantity': 1, 'optional': False, 'prerequisites': None}, {'id': 'side_quest_2_obj_2', 'description': 'Help solve it', 'type': 'talk_to_npc', 'target': 'Brother Aldric', 'quantity': 1, 'optional': False, 'prerequisites': None}, {'id': 'side_quest_2_obj_3', 'description': 'Return for thanks', 'type': 'talk_to_npc', 'target': 'Brother Aldric', 'quantity': 1, 'optional': False, 'prerequisites': None}], 'rewards': {'experience': 77, 'gold': 32, 'items': ['Thank You Gift'], 'relationship_changes': None}, 'prerequisites': None, 'level_requirement': 1, 'estimated_duration': '15-30 minutes', 'quest_type': 'side', 'interconnected_quests': ['side_quest_3_aldric_517', 'side_quest_5_brother_hilda'], 'narrative_importance': 'low'}
