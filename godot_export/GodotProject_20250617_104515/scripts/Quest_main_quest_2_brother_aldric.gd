...
class_name Quest_main_quest_2_brother_aldric

var quest_data: Dictionary = {'id': 'main_quest_2_brother_aldric', 'title': 'Ancient Secrets', 'description': 'Brother Aldric has discovered something that could change everything.', 'summary': 'Help Brother Aldric with ancient secrets', 'giver_npc': 'Brother Aldric', 'objectives': [{'id': 'main_quest_2_obj_1', 'description': 'Learn about the discovery', 'type': 'investigate', 'target': 'location', 'quantity': 1, 'optional': False, 'prerequisites': None}, {'id': 'main_quest_2_obj_2', 'description': 'Search for more clues', 'type': 'investigate', 'target': 'location', 'quantity': 1, 'optional': False, 'prerequisites': None}, {'id': 'main_quest_2_obj_3', 'description': 'Uncover the truth', 'type': 'investigate', 'target': 'location', 'quantity': 1, 'optional': False, 'prerequisites': None}, {'id': 'main_quest_2_obj_4', 'description': 'Decide what to do', 'type': 'investigate', 'target': 'location', 'quantity': 1, 'optional': False, 'prerequisites': None}], 'rewards': {'experience': 312, 'gold': 130, 'items': [], 'relationship_changes': None}, 'prerequisites': ['main_quest_1_sister_dara'], 'level_requirement': 2, 'estimated_duration': '15-30 minutes', 'quest_type': 'main', 'interconnected_quests': ['side_quest_3_aldric_517', 'side_quest_5_brother_hilda'], 'narrative_importance': 'high'}
