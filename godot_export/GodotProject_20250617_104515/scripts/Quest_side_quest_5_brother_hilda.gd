...
class_name Quest_side_quest_5_brother_hilda

var quest_data: Dictionary = {'id': 'side_quest_5_brother_hilda', 'title': 'Personal Favor', 'description': 'Brother Hilda needs help with a personal matter.', 'summary': 'Help Brother Hilda with personal favor', 'giver_npc': 'Brother Hilda', 'objectives': [{'id': 'side_quest_5_obj_1', 'description': 'Listen to the problem', 'type': 'talk_to_npc', 'target': 'Brother Hilda', 'quantity': 1, 'optional': False, 'prerequisites': None}, {'id': 'side_quest_5_obj_2', 'description': 'Help solve it', 'type': 'talk_to_npc', 'target': 'Brother Hilda', 'quantity': 1, 'optional': False, 'prerequisites': None}, {'id': 'side_quest_5_obj_3', 'description': 'Return for thanks', 'type': 'talk_to_npc', 'target': 'Brother Hilda', 'quantity': 1, 'optional': False, 'prerequisites': None}], 'rewards': {'experience': 77, 'gold': 32, 'items': ['Thank You Gift'], 'relationship_changes': None}, 'prerequisites': None, 'level_requirement': 1, 'estimated_duration': '15-30 minutes', 'quest_type': 'side', 'interconnected_quests': ['main_quest_1_sister_dara', 'side_quest_1_sister_dara', 'main_quest_2_brother_aldric'], 'narrative_importance': 'low'}
