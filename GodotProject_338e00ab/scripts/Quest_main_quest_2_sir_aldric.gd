...
class_name Quest_main_quest_2_sir_aldric

var quest_data: Dictionary = {
    "id": "main_quest_2_sir_aldric",
    "title": "Ancient Secrets",
    "description": "Sir Aldric has discovered something that could change everything.",
    "summary": "Help Sir Aldric with ancient secrets",
    "giver_npc": "Sir Aldric",
    "objectives": [
    {
    ...
    "prerequisites": ["main_quest_1_master_brenna"],
    "level_requirement": 2,
    "estimated_duration": "15-30 minutes",
    "quest_type": "main",
    "interconnected_quests": [
    "main_quest_1_master_brenna",
    "side_quest_1_master_brenna"
],
