...
class_name Quest_main_quest_1_brother_edwin

var quest_data: Dictionary = {'id': 'main_quest_1_brother_edwin', 'title': 'The Village Crisis', 'description': 'Brother Edwin needs help resolving a crisis that threatens the village.', 'summary': 'Help Brother Edwin with the village crisis', 'giver_npc': 'Brother Edwin', 'objectives': [{'id': 'main_quest_1_obj_1', 'description': 'Investigate the problem', 'type': 'investigate', 'target': 'location', 'quantity': 1, 'optional': False, 'prerequisites': None}, {'id': 'main_quest_1_obj_2', 'description': 'Gather information from villagers', 'type': 'investigate', 'target': 'location', 'quantity': 1, 'optional': False, 'prerequisites': None}, {'id': 'main_quest_1_obj_3', 'description': 'Find a solution', 'type': 'investigate', 'target': 'location', 'quantity': 1, 'optional': False, 'prerequisites': None}, {'id': 'main_quest_1_obj_4', 'description': 'Report back', 'type': 'investigate', 'target': 'Brother Edwin', 'quantity': 1, 'optional': False, 'prerequisites': None}], 'rewards': {'experience': 156, 'gold': 65, 'items': ['Quest Item 1'], 'relationship_changes': None}, 'prerequisites': None, 'level_requirement': 1, 'estimated_duration': '15-30 minutes', 'quest_type': 'main', 'interconnected_quests': ['main_quest_2_sir_fiona'], 'narrative_importance': 'high'}
