...
# Style Parameters: {'construction': 'wood', 'roof_style': 'thatched', 'bucket_system': 'pulley', 'water_level': 'medium', 'decoration': 'ivy_covered', 'age': 'crumbling'}
...
# AI Texture paths
ai_textures = {"stone": "complete_game_content/complete_game_20250617_045108_medivial/ai_creative_assets/ai_textures/stone_medieval_617a3552.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.9196824936057767
WIDTH_MULT = 0.9716352401801632
COMPLEXITY = "simple"
DETAIL_COUNT = 5
ASYMMETRY = 0.10068779614678684
...
def create_ai_rock():
    ...
    rock.name = f"AI_rounded_rock_65"
...
try:
    ...
    print(f"🎨 Style: {'construction': 'wood', 'roof_style': 'thatched', 'bucket_system': 'pulley', 'water_level': 'medium', 'decoration': 'ivy_covered', 'age': 'crumbling'}")
