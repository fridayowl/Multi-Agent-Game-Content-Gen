...
# Style Parameters: {'trunk_style': 'gnarled', 'canopy_shape': 'sparse', 'branch_density': 'sparse', 'leaf_type': 'broad', 'seasonal_state': 'summer', 'bark_texture': 'rough', 'height_variation': 'tall'}
...
# AI Texture paths
ai_textures = {"bark": "complete_game_content/complete_game_20250617_045108_medivial/ai_creative_assets/ai_textures/wood_medieval_a95ac735.png", "leaves": "complete_game_content/complete_game_20250617_045108_medivial/ai_creative_assets/ai_textures/foliage_medieval_b15f18a1.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.9092927138474391
WIDTH_MULT = 1.2152416744143484
COMPLEXITY = "simple"
DETAIL_COUNT = 5
ASYMMETRY = 0.19899027926254165
...
def create_ai_unique_oak_tree():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_oak_tree_60"
...
try:
    ...
    print(f"🎨 Style: {'trunk_style': 'gnarled', 'canopy_shape': 'sparse', 'branch_density': 'sparse', 'leaf_type': 'broad', 'seasonal_state': 'summer', 'bark_texture': 'rough', 'height_variation': 'tall'}")
