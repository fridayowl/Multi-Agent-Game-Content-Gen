...
# Style Parameters: {'shape': 'upright', 'density': 'sparse', 'leaf_size': 'small', 'flowering': 'year_round', 'berry_type': 'none', 'thorns': 'none'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_045108_medivial/ai_creative_assets/ai_textures/foliage_medieval_91d3582a.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.8953914318155697
WIDTH_MULT = 0.9014626408406473
COMPLEXITY = "medium"
DETAIL_COUNT = 3
ASYMMETRY = 0.33409257225691846
...
def create_ai_rock():
    ...
    rock.name = f"AI_upright_rock_57"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_upright_bush_57"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'upright', 'density': 'sparse', 'leaf_size': 'small', 'flowering': 'year_round', 'berry_type': 'none', 'thorns': 'none'}")
