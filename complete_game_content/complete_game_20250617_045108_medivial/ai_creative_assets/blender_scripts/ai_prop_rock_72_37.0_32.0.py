...
# Style Parameters: {'shape': 'angular', 'surface': 'mossy', 'size_category': 'small', 'formation': 'pile', 'weathering': 'ancient', 'mineral_type': 'sandstone'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_045108_medivial/ai_creative_assets/ai_textures/stone_medieval_392c1ef6.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.7497075100928473
WIDTH_MULT = 1.2560064126783343
COMPLEXITY = "simple"
DETAIL_COUNT = 5
ASYMMETRY = 0.3338368324826146
...
try:
    ...
    print(f"🎨 Style: {'shape': 'angular', 'surface': 'mossy', 'size_category': 'small', 'formation': 'pile', 'weathering': 'ancient', 'mineral_type': 'sandstone'}")
