...
# Style Parameters: {'construction': 'stone', 'roof_style': 'tiled', 'bucket_system': 'rope', 'water_level': 'high', 'decoration': 'carved', 'age': 'weathered'}
...
# AI Texture paths
ai_textures = {"stone": "complete_game_content/complete_game_20250615_141816_Medieval_game/ai_creative_assets/ai_textures/stone_medieval_b5e0adc1.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.1799745433457203
WIDTH_MULT = 0.8672182970614127
COMPLEXITY = "complex"
DETAIL_COUNT = 4
ASYMMETRY = 0.333269227403181
...
def create_ai_rock():
    ...
    rock.name = f"AI_rounded_rock_17"
...
try:
    ...
    print(f"🎨 Style: {'construction': 'stone', 'roof_style': 'tiled', 'bucket_system': 'rope', 'water_level': 'high', 'decoration': 'carved', 'age': 'weathered'}")
