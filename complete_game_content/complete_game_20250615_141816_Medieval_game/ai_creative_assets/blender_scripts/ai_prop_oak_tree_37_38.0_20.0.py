...
# Style Parameters: {'trunk_style': 'split', 'canopy_shape': 'oval', 'branch_density': 'sparse', 'leaf_type': 'broad', 'seasonal_state': 'autumn', 'bark_texture': 'scarred', 'height_variation': 'ancient'}
...
# AI Texture paths
ai_textures = {"bark": "complete_game_content/complete_game_20250615_141816_Medieval_game/ai_creative_assets/ai_textures/wood_medieval_ceb5e68f.png", "leaves": "complete_game_content/complete_game_20250615_141816_Medieval_game/ai_creative_assets/ai_textures/foliage_medieval_3283059b.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 2.0818798826963203
WIDTH_MULT = 1.0498986437430815
COMPLEXITY = "medium"
DETAIL_COUNT = 5
ASYMMETRY = 0.3372530846206111
...
def create_ai_unique_oak_tree():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_oak_tree_37"
...
try:
    ...
    print(f"🎨 Style: {'trunk_style': 'split', 'canopy_shape': 'oval', 'branch_density': 'sparse', 'leaf_type': 'broad', 'seasonal_state': 'autumn', 'bark_texture': 'scarred', 'height_variation': 'ancient'}")
