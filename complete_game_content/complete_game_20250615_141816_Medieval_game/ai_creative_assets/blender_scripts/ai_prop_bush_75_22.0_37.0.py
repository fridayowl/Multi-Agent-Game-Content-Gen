...
# Style Parameters: {'shape': 'oval', 'density': 'medium', 'leaf_size': 'small', 'flowering': 'summer', 'berry_type': 'red', 'thorns': 'none'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250615_141816_Medieval_game/ai_creative_assets/ai_textures/foliage_medieval_807df5c4.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.2990481206673572
WIDTH_MULT = 0.880550030818701
COMPLEXITY = "medium"
DETAIL_COUNT = 5
ASYMMETRY = 0.16812410154561996
...
try:
    ...
    print(f"🎨 Style: {'shape': 'oval', 'density': 'medium', 'leaf_size': 'small', 'flowering': 'summer', 'berry_type': 'red', 'thorns': 'none'}")
