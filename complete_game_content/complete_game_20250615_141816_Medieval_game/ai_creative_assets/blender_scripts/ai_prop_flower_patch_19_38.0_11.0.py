...
# Prop #20: flower_patch
# AI Description: A unique medieval flower_patch with distinctive characteristics
# Style Parameters: {'shape': 'organic', 'size': 'medium', 'texture': 'rough', 'color_scheme': 'monochrome', 'complexity': 'intricate'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250615_141816_Medieval_game/ai_creative_assets/ai_textures/generic_medieval_5057c6d0.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.865346568420649
WIDTH_MULT = 1.255088560178867
COMPLEXITY = "simple"
DETAIL_COUNT = 5
ASYMMETRY = 0.29983567950685014
...
def create_ai_unique_flower_patch():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_flower_patch_19"
...
def create_ai_rock():
    ...
    rock.name = f"AI_organic_rock_19"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_organic_bush_19"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'organic', 'size': 'medium', 'texture': 'rough', 'color_scheme': 'monochrome', 'complexity': 'intricate'}")
