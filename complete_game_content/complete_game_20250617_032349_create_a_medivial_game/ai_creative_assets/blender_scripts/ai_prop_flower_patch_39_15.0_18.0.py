...
# Prop #40: flower_patch
# AI Description: A unique medieval flower_patch with distinctive characteristics
# Style Parameters: {'shape': 'geometric', 'size': 'small', 'texture': 'rough', 'color_scheme': 'vibrant', 'complexity': 'simple'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_032349_create_a_medivial_game/ai_creative_assets/ai_textures/generic_medieval_7e150463.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.8880221373182797
WIDTH_MULT = 1.1280683167960694
COMPLEXITY = "complex"
DETAIL_COUNT = 5
ASYMMETRY = 0.181496316103755
...
def create_ai_unique_flower_patch():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_flower_patch_39"
...
def create_ai_tree():
    ...
    if trunk_style == "twisted":
        ...
        for i in range(max(2, DETAIL_COUNT // 2)):
            ...
            segment.name = f"AI_twisted_segment_{i}_39"
        ...
        trunk.name = f"AI_gnarled_trunk_39"
        ...
        for i in range(2):
            ...
            branch.name = f"AI_split_branch_{i}_39"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_straight_trunk_39"
        tree_parts.append(trunk)
    ...
    if canopy_shape == "round":
        ...
        canopy.name = f"AI_round_canopy_39"
        ...
        canopy.name = f"AI_oval_canopy_39"
        tree_parts.append(canopy)
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere.name = f"AI_irregular_canopy_{i}_39"
        ...
        for i in range(cluster_count):
            ...
            cluster.name = f"AI_sparse_cluster_{i}_39"
        ...
        for i in range(frond_count):
            ...
            frond.name = f"AI_palm_frond_{i}_39"
        ...
        canopy = bpy.context.active_object
        canopy.name = f"AI_default_canopy_39"
        tree_parts.append(canopy)
...
def create_ai_rock():
    ...
    if rock_shape == "angular":
        ...
        for i in range(DETAIL_COUNT // 2):
            ...
            crystal.name = f"AI_crystal_{i}_39"
    ...
    rock.name = f"AI_geometric_rock_39"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere = bpy.context.active_object
            sphere.name = f"AI_spreading_bush_{i}_39"
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_geometric_bush_39"
...
def create_ai_generic_prop():
    ...
    prop.name = f"AI_generic_prop_39"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'geometric', 'size': 'small', 'texture': 'rough', 'color_scheme': 'vibrant', 'complexity': 'simple'}")
