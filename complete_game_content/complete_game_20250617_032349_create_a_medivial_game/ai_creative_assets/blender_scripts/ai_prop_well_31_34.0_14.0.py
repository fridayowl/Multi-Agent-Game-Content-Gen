...
# Style Parameters: {'construction': 'stone', 'roof_style': 'none', 'bucket_system': 'pulley', 'water_level': 'dry', 'decoration': 'ivy_covered', 'age': 'ancient'}
...
# AI Texture paths
ai_textures = {"stone": "complete_game_content/complete_game_20250617_032349_create_a_medivial_game/ai_creative_assets/ai_textures/stone_medieval_3dcef164.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.151891958714729
WIDTH_MULT = 1.1737975220420804
COMPLEXITY = "simple"
DETAIL_COUNT = 6
ASYMMETRY = 0.3079737131460527
...
def create_ai_rock():
    ...
    rock.name = f"AI_rounded_rock_31"
...
try:
    ...
    print(f"🎨 Style: {'construction': 'stone', 'roof_style': 'none', 'bucket_system': 'pulley', 'water_level': 'dry', 'decoration': 'ivy_covered', 'age': 'ancient'}")
