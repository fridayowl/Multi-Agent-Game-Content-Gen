...
# Style Parameters: {'shape': 'rounded', 'surface': 'rough', 'size_category': 'small', 'formation': 'single', 'weathering': 'ancient', 'mineral_type': 'basalt'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_032349_create_a_medivial_game/ai_creative_assets/ai_textures/stone_medieval_000cb71c.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.9407814815835895
WIDTH_MULT = 1.4691759717580477
COMPLEXITY = "complex"
DETAIL_COUNT = 5
ASYMMETRY = 0.20010915004600482
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_rounded_bush_53"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'rounded', 'surface': 'rough', 'size_category': 'small', 'formation': 'single', 'weathering': 'ancient', 'mineral_type': 'basalt'}")
