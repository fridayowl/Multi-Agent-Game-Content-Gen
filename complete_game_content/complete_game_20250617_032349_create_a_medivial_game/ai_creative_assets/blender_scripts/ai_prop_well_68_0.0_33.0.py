...
# Style Parameters: {'construction': 'wood', 'roof_style': 'tiled', 'bucket_system': 'rope', 'water_level': 'low', 'decoration': 'plain', 'age': 'weathered'}
...
# AI Texture paths
ai_textures = {"stone": "complete_game_content/complete_game_20250617_032349_create_a_medivial_game/ai_creative_assets/ai_textures/stone_medieval_53affc3f.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.8602373725109332
WIDTH_MULT = 1.0376317471128007
COMPLEXITY = "simple"
DETAIL_COUNT = 5
ASYMMETRY = 0.3768651664297267
...
try:
    ...
    print(f"🎨 Style: {'construction': 'wood', 'roof_style': 'tiled', 'bucket_system': 'rope', 'water_level': 'low', 'decoration': 'plain', 'age': 'weathered'}")
