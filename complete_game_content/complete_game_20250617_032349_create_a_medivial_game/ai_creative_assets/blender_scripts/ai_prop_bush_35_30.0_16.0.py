...
# Style Parameters: {'shape': 'upright', 'density': 'sparse', 'leaf_size': 'medium', 'flowering': 'summer', 'berry_type': 'black', 'thorns': 'light'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_032349_create_a_medivial_game/ai_creative_assets/ai_textures/foliage_medieval_61eb956a.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.329775680081104
WIDTH_MULT = 1.013694593971041
COMPLEXITY = "complex"
DETAIL_COUNT = 2
ASYMMETRY = 0.2024210417700782
...
def create_ai_rock():
    ...
    rock.name = f"AI_upright_rock_35"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_upright_bush_35"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'upright', 'density': 'sparse', 'leaf_size': 'medium', 'flowering': 'summer', 'berry_type': 'black', 'thorns': 'light'}")
