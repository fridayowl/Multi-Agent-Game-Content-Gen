...
# Style Parameters: {'shape': 'crystalline', 'surface': 'rough', 'size_category': 'boulder', 'formation': 'single', 'weathering': 'ancient', 'mineral_type': 'granite'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_031750_create_a_medivial_game/ai_creative_assets/ai_textures/stone_medieval_faed2ddc.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.8023019402742426
WIDTH_MULT = 1.6865060253725914
COMPLEXITY = "medium"
DETAIL_COUNT = 5
ASYMMETRY = 0.31933506645269216
...
def create_ai_rock():
    ...
    rock.name = f"AI_crystalline_rock_66"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_crystalline_bush_66"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'crystalline', 'surface': 'rough', 'size_category': 'boulder', 'formation': 'single', 'weathering': 'ancient', 'mineral_type': 'granite'}")
