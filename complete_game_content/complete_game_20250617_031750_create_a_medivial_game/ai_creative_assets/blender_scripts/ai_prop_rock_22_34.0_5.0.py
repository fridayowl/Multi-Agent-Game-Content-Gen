...
# Style Parameters: {'shape': 'angular', 'surface': 'rough', 'size_category': 'large', 'formation': 'pile', 'weathering': 'weathered', 'mineral_type': 'basalt'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_031750_create_a_medivial_game/ai_creative_assets/ai_textures/stone_medieval_2e32ba84.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.5388123815501139
WIDTH_MULT = 1.5253620988600076
COMPLEXITY = "medium"
DETAIL_COUNT = 3
ASYMMETRY = 0.27616324425772065
...
try:
    ...
    print(f"🎨 Style: {'shape': 'angular', 'surface': 'rough', 'size_category': 'large', 'formation': 'pile', 'weathering': 'weathered', 'mineral_type': 'basalt'}")
