...
# Prop #41: desert_flower
# AI Description: A unique desert desert_flower with distinctive characteristics
# Style Parameters: {'shape': 'geometric', 'size': 'medium', 'texture': 'smooth', 'color_scheme': 'monochrome', 'complexity': 'complex'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_113928_Generate_a_desert_oasis_tradin/ai_creative_assets/ai_textures/generic_desert_dfd3bb1e.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.2751235632984188
WIDTH_MULT = 0.9222141590095304
COMPLEXITY = "medium"
DETAIL_COUNT = 4
ASYMMETRY = 0.2866638816384638
...
def create_ai_unique_desert_flower():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_desert_flower_40"
...
def create_ai_tree():
    ...
    if trunk_style == "twisted":
        ...
        for i in range(max(2, DETAIL_COUNT // 2)):
            ...
            segment.name = f"AI_twisted_segment_{i}_40"
        ...
        trunk.name = f"AI_gnarled_trunk_40"
        ...
        for i in range(2):
            ...
            branch.name = f"AI_split_branch_{i}_40"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_straight_trunk_40"
        tree_parts.append(trunk)
    ...
    if canopy_shape == "round":
        ...
        canopy.name = f"AI_round_canopy_40"
        ...
        canopy.name = f"AI_oval_canopy_40"
        tree_parts.append(canopy)
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere.name = f"AI_irregular_canopy_{i}_40"
        ...
        for i in range(cluster_count):
            ...
            cluster.name = f"AI_sparse_cluster_{i}_40"
        ...
        for i in range(frond_count):
            ...
            frond.name = f"AI_palm_frond_{i}_40"
        ...
        canopy = bpy.context.active_object
        canopy.name = f"AI_default_canopy_40"
        tree_parts.append(canopy)
...
def create_ai_rock():
    ...
    if rock_shape == "angular":
        ...
        for i in range(DETAIL_COUNT // 2):
            ...
            crystal.name = f"AI_crystal_{i}_40"
    ...
    rock.name = f"AI_geometric_rock_40"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere = bpy.context.active_object
            sphere.name = f"AI_spreading_bush_{i}_40"
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_geometric_bush_40"
...
def create_ai_generic_prop():
    ...
    prop.name = f"AI_generic_prop_40"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'geometric', 'size': 'medium', 'texture': 'smooth', 'color_scheme': 'monochrome', 'complexity': 'complex'}")
