...
# Style Parameters: {'trunk_style': 'split', 'canopy_shape': 'sparse', 'branch_density': 'dense', 'leaf_type': 'none', 'seasonal_state': 'autumn', 'bark_texture': 'cracked', 'height_variation': 'normal'}
...
# AI Texture paths
ai_textures = {"bark": "complete_game_content/complete_game_20250616_021317_create_a_spooky_3d_game/ai_creative_assets/ai_textures/wood_spooky_7f81394d.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.3858670400553583
WIDTH_MULT = 1.1937198028542548
COMPLEXITY = "complex"
DETAIL_COUNT = 6
ASYMMETRY = 0.23298278546853438
...
try:
    ...
    print(f"🎨 Style: {'trunk_style': 'split', 'canopy_shape': 'sparse', 'branch_density': 'dense', 'leaf_type': 'none', 'seasonal_state': 'autumn', 'bark_texture': 'cracked', 'height_variation': 'normal'}")
