...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250616_021317_create_a_spooky_3d_game/ai_creative_assets/ai_textures/generic_spooky_f4e19ced.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.8503537912538739
WIDTH_MULT = 0.8938362006700229
COMPLEXITY = "simple"
DETAIL_COUNT = 2
ASYMMETRY = 0.2834717242700947
...
def create_ai_unique_fog_patch():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_fog_patch_51"
