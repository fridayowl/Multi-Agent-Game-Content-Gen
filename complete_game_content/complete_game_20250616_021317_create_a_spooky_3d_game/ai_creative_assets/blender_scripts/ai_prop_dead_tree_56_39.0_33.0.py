...
# Style Parameters: {'trunk_style': 'straight', 'canopy_shape': 'sparse', 'branch_density': 'dense', 'leaf_type': 'none', 'seasonal_state': 'autumn', 'bark_texture': 'cracked', 'height_variation': 'dwarf'}
...
# AI Texture paths
ai_textures = {"bark": "complete_game_content/complete_game_20250616_021317_create_a_spooky_3d_game/ai_creative_assets/ai_textures/wood_spooky_fa1e24b9.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.1059031227946885
WIDTH_MULT = 1.0324250823791306
COMPLEXITY = "medium"
DETAIL_COUNT = 3
ASYMMETRY = 0.16511763105560268
...
def create_ai_unique_dead_tree():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_dead_tree_56"
...
try:
    ...
    print(f"🎨 Style: {'trunk_style': 'straight', 'canopy_shape': 'sparse', 'branch_density': 'dense', 'leaf_type': 'none', 'seasonal_state': 'autumn', 'bark_texture': 'cracked', 'height_variation': 'dwarf'}")
