...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250616_021317_create_a_spooky_3d_game/ai_creative_assets/ai_textures/generic_spooky_c47f6b82.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.168676967632395
WIDTH_MULT = 1.2156186194735472
COMPLEXITY = "complex"
DETAIL_COUNT = 5
ASYMMETRY = 0.2863183199933853
...
def create_ai_unique_fog_patch():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_fog_patch_2"
