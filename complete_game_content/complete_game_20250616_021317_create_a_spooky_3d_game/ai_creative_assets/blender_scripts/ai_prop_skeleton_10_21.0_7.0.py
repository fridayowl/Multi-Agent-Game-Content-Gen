...
# Style Parameters: {'shape': 'geometric', 'size': 'medium', 'texture': 'rough', 'color_scheme': 'vibrant', 'complexity': 'intricate'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250616_021317_create_a_spooky_3d_game/ai_creative_assets/ai_textures/generic_spooky_89d10b40.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.469976145429993
WIDTH_MULT = 0.9800539187454256
COMPLEXITY = "complex"
DETAIL_COUNT = 3
ASYMMETRY = 0.18111473707792092
...
def create_ai_unique_skeleton():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_skeleton_10"
...
def create_ai_rock():
    ...
    rock.name = f"AI_geometric_rock_10"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_geometric_bush_10"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'geometric', 'size': 'medium', 'texture': 'rough', 'color_scheme': 'vibrant', 'complexity': 'intricate'}")
