...
# Style Parameters: {'shape': 'organic', 'size': 'medium', 'texture': 'rough', 'color_scheme': 'monochrome', 'complexity': 'moderate'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250616_021317_create_a_spooky_3d_game/ai_creative_assets/ai_textures/generic_spooky_40a8750a.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.9091372443355157
WIDTH_MULT = 0.9069197418974255
COMPLEXITY = "medium"
DETAIL_COUNT = 3
ASYMMETRY = 0.18913492442543367
...
try:
    ...
    print(f"🎨 Style: {'shape': 'organic', 'size': 'medium', 'texture': 'rough', 'color_scheme': 'monochrome', 'complexity': 'moderate'}")
