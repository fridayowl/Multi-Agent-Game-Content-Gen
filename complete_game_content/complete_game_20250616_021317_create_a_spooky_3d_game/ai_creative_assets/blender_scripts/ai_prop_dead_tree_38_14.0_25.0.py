...
# Style Parameters: {'trunk_style': 'twisted', 'canopy_shape': 'round', 'branch_density': 'medium', 'leaf_type': 'none', 'seasonal_state': 'autumn', 'bark_texture': 'cracked', 'height_variation': 'normal'}
...
# AI Texture paths
ai_textures = {"bark": "complete_game_content/complete_game_20250616_021317_create_a_spooky_3d_game/ai_creative_assets/ai_textures/wood_spooky_242818d7.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.9466283844792376
WIDTH_MULT = 1.1585049587074785
COMPLEXITY = "complex"
DETAIL_COUNT = 2
ASYMMETRY = 0.10308385418196178
...
def create_ai_unique_dead_tree():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_dead_tree_38"
...
try:
    ...
    print(f"🎨 Style: {'trunk_style': 'twisted', 'canopy_shape': 'round', 'branch_density': 'medium', 'leaf_type': 'none', 'seasonal_state': 'autumn', 'bark_texture': 'cracked', 'height_variation': 'normal'}")
