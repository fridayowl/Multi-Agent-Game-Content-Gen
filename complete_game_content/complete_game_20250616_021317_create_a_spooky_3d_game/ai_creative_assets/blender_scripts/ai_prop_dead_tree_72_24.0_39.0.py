...
# Style Parameters: {'trunk_style': 'twisted', 'canopy_shape': 'oval', 'branch_density': 'sparse', 'leaf_type': 'none', 'seasonal_state': 'autumn', 'bark_texture': 'cracked', 'height_variation': 'normal'}
...
# AI Texture paths
ai_textures = {"bark": "complete_game_content/complete_game_20250616_021317_create_a_spooky_3d_game/ai_creative_assets/ai_textures/wood_spooky_5e393773.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.9765812580644979
WIDTH_MULT = 1.0174863368849416
COMPLEXITY = "medium"
DETAIL_COUNT = 5
ASYMMETRY = 0.2857438273125275
...
try:
    ...
    print(f"🎨 Style: {'trunk_style': 'twisted', 'canopy_shape': 'oval', 'branch_density': 'sparse', 'leaf_type': 'none', 'seasonal_state': 'autumn', 'bark_texture': 'cracked', 'height_variation': 'normal'}")
