...
# Style Parameters: {'trunk_style': 'split', 'canopy_shape': 'irregular', 'branch_density': 'sparse', 'leaf_type': 'none', 'seasonal_state': 'autumn', 'bark_texture': 'cracked', 'height_variation': 'normal'}
...
# AI Texture paths
ai_textures = {"bark": "complete_game_content/complete_game_20250616_021317_create_a_spooky_3d_game/ai_creative_assets/ai_textures/wood_spooky_2729322a.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.3829400252028594
WIDTH_MULT = 1.0556133685719071
COMPLEXITY = "simple"
DETAIL_COUNT = 5
ASYMMETRY = 0.3944231747934579
...
try:
    ...
    print(f"🎨 Style: {'trunk_style': 'split', 'canopy_shape': 'irregular', 'branch_density': 'sparse', 'leaf_type': 'none', 'seasonal_state': 'autumn', 'bark_texture': 'cracked', 'height_variation': 'normal'}")
