...
# Style Parameters: {'shape': 'angular', 'size': 'large', 'texture': 'weathered', 'color_scheme': 'vibrant', 'complexity': 'intricate'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250616_021159_make_a_spooky_game/ai_creative_assets/ai_textures/generic_spooky_f4500ee9.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.2222042653049068
WIDTH_MULT = 1.161324128070898
COMPLEXITY = "medium"
DETAIL_COUNT = 5
ASYMMETRY = 0.35734230531617106
...
def create_ai_unique_fog_patch():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_fog_patch_72"
...
def create_ai_rock():
    ...
    rock.name = f"AI_angular_rock_72"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_angular_bush_72"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'angular', 'size': 'large', 'texture': 'weathered', 'color_scheme': 'vibrant', 'complexity': 'intricate'}")
