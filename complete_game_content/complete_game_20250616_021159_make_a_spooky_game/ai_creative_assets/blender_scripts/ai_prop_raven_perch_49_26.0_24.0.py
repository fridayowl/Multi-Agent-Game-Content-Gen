...
# Style Parameters: {'shape': 'geometric', 'size': 'small', 'texture': 'rough', 'color_scheme': 'natural', 'complexity': 'simple'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250616_021159_make_a_spooky_game/ai_creative_assets/ai_textures/generic_spooky_e1c5af78.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.1024363737084997
WIDTH_MULT = 0.8205687193177758
COMPLEXITY = "complex"
DETAIL_COUNT = 6
ASYMMETRY = 0.18200760638973373
...
def create_ai_unique_raven_perch():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_raven_perch_49"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'geometric', 'size': 'small', 'texture': 'rough', 'color_scheme': 'natural', 'complexity': 'simple'}")
