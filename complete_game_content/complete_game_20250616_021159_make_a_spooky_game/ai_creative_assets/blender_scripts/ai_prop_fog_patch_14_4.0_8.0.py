...
# Style Parameters: {'shape': 'round', 'size': 'large', 'texture': 'smooth', 'color_scheme': 'vibrant', 'complexity': 'simple'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250616_021159_make_a_spooky_game/ai_creative_assets/ai_textures/generic_spooky_bd32c4be.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.8594226373298424
WIDTH_MULT = 0.8714732569013246
COMPLEXITY = "simple"
DETAIL_COUNT = 2
ASYMMETRY = 0.11564116738268963
...
try:
    ...
    print(f"🎨 Style: {'shape': 'round', 'size': 'large', 'texture': 'smooth', 'color_scheme': 'vibrant', 'complexity': 'simple'}")
