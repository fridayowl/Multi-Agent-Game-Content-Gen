...
# Style Parameters: {'shape': 'flat', 'surface': 'cracked', 'size_category': 'large', 'formation': 'single', 'weathering': 'eroded', 'mineral_type': 'granite'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_033737_medivial_game/ai_creative_assets/ai_textures/stone_medieval_e0710e6e.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.7821215043094942
WIDTH_MULT = 1.4720629817420958
COMPLEXITY = "complex"
DETAIL_COUNT = 6
ASYMMETRY = 0.39206754800978116
...
try:
    ...
    print(f"🎨 Style: {'shape': 'flat', 'surface': 'cracked', 'size_category': 'large', 'formation': 'single', 'weathering': 'eroded', 'mineral_type': 'granite'}")
