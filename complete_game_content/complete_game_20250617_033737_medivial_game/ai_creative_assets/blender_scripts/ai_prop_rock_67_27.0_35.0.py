...
# Style Parameters: {'shape': 'flat', 'surface': 'smooth', 'size_category': 'small', 'formation': 'single', 'weathering': 'weathered', 'mineral_type': 'granite'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_033737_medivial_game/ai_creative_assets/ai_textures/stone_medieval_0c91c287.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.9612558275310286
WIDTH_MULT = 1.6902128961864338
COMPLEXITY = "simple"
DETAIL_COUNT = 2
ASYMMETRY = 0.16651045708067908
...
try:
    ...
    print(f"🎨 Style: {'shape': 'flat', 'surface': 'smooth', 'size_category': 'small', 'formation': 'single', 'weathering': 'weathered', 'mineral_type': 'granite'}")
