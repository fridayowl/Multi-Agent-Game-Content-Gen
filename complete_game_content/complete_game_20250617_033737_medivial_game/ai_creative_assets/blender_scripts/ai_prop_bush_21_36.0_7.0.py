...
# Style Parameters: {'shape': 'spreading', 'density': 'overgrown', 'leaf_size': 'large', 'flowering': 'none', 'berry_type': 'red', 'thorns': 'none'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_033737_medivial_game/ai_creative_assets/ai_textures/foliage_medieval_b00d6a8f.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.0452779093122946
WIDTH_MULT = 1.245961713758134
COMPLEXITY = "medium"
DETAIL_COUNT = 5
ASYMMETRY = 0.16678133518369398
...
try:
    ...
    print(f"🎨 Style: {'shape': 'spreading', 'density': 'overgrown', 'leaf_size': 'large', 'flowering': 'none', 'berry_type': 'red', 'thorns': 'none'}")
