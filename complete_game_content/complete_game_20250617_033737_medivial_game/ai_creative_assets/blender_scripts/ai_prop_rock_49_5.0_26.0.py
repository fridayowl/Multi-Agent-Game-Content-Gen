...
# Style Parameters: {'shape': 'angular', 'surface': 'cracked', 'size_category': 'medium', 'formation': 'pile', 'weathering': 'eroded', 'mineral_type': 'granite'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_033737_medivial_game/ai_creative_assets/ai_textures/stone_medieval_a3692af3.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.9190003139711677
WIDTH_MULT = 1.1100433461488883
COMPLEXITY = "simple"
DETAIL_COUNT = 4
ASYMMETRY = 0.1451360661438568
...
try:
    ...
    print(f"🎨 Style: {'shape': 'angular', 'surface': 'cracked', 'size_category': 'medium', 'formation': 'pile', 'weathering': 'eroded', 'mineral_type': 'granite'}")
