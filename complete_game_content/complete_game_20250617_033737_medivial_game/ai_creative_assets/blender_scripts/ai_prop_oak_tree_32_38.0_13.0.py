...
# Style Parameters: {'trunk_style': 'twisted', 'canopy_shape': 'sparse', 'branch_density': 'sparse', 'leaf_type': 'broad', 'seasonal_state': 'winter', 'bark_texture': 'scarred', 'height_variation': 'ancient'}
...
# AI Texture paths
ai_textures = {"bark": "complete_game_content/complete_game_20250617_033737_medivial_game/ai_creative_assets/ai_textures/wood_medieval_dbe3559a.png", "leaves": "complete_game_content/complete_game_20250617_033737_medivial_game/ai_creative_assets/ai_textures/foliage_medieval_18098952.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.8806183944811385
WIDTH_MULT = 1.2067811858996198
COMPLEXITY = "medium"
DETAIL_COUNT = 5
ASYMMETRY = 0.18560204990027634
...
def create_ai_unique_oak_tree():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_oak_tree_32"
...
try:
    ...
    print(f"🎨 Style: {'trunk_style': 'twisted', 'canopy_shape': 'sparse', 'branch_density': 'sparse', 'leaf_type': 'broad', 'seasonal_state': 'winter', 'bark_texture': 'scarred', 'height_variation': 'ancient'}")
