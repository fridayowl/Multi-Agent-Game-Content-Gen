...
# Style Parameters: {'shape': 'round', 'size': 'small', 'texture': 'weathered', 'color_scheme': 'natural', 'complexity': 'moderate'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250616_201827_medivial_spooky_game/ai_creative_assets/ai_textures/generic_spooky_83457b81.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.407930695927143
WIDTH_MULT = 0.8671603593102238
COMPLEXITY = "simple"
DETAIL_COUNT = 4
ASYMMETRY = 0.21772346297111456
...
def create_ai_unique_tombstone():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_tombstone_41"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'round', 'size': 'small', 'texture': 'weathered', 'color_scheme': 'natural', 'complexity': 'moderate'}")
