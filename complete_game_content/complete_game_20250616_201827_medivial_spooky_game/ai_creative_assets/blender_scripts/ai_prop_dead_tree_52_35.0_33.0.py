...
# Style Parameters: {'trunk_style': 'gnarled', 'canopy_shape': 'irregular', 'branch_density': 'dense', 'leaf_type': 'none', 'seasonal_state': 'autumn', 'bark_texture': 'cracked', 'height_variation': 'dwarf'}
...
# AI Texture paths
ai_textures = {"bark": "complete_game_content/complete_game_20250616_201827_medivial_spooky_game/ai_creative_assets/ai_textures/wood_spooky_d87dbc09.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.3870444926659804
WIDTH_MULT = 1.1824963182027706
COMPLEXITY = "complex"
DETAIL_COUNT = 4
ASYMMETRY = 0.12673237859413974
...
try:
    ...
    print(f"🎨 Style: {'trunk_style': 'gnarled', 'canopy_shape': 'irregular', 'branch_density': 'dense', 'leaf_type': 'none', 'seasonal_state': 'autumn', 'bark_texture': 'cracked', 'height_variation': 'dwarf'}")
