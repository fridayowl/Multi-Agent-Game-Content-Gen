...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250616_201827_medivial_spooky_game/ai_creative_assets/ai_textures/generic_spooky_1b8bf3aa.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.3600955010147304
WIDTH_MULT = 0.8690630248068459
COMPLEXITY = "complex"
DETAIL_COUNT = 3
ASYMMETRY = 0.3024489475764947
...
def create_ai_unique_tombstone():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_tombstone_46"
