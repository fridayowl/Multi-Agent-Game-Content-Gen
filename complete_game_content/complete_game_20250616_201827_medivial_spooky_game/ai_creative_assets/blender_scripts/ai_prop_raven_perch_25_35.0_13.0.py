...
# Style Parameters: {'shape': 'angular', 'size': 'small', 'texture': 'rough', 'color_scheme': 'vibrant', 'complexity': 'moderate'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250616_201827_medivial_spooky_game/ai_creative_assets/ai_textures/generic_spooky_d7fd7cfd.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.8443146589169811
WIDTH_MULT = 1.1555572874149735
COMPLEXITY = "medium"
DETAIL_COUNT = 4
ASYMMETRY = 0.22679614474850185
...
def create_ai_unique_raven_perch():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_raven_perch_25"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'angular', 'size': 'small', 'texture': 'rough', 'color_scheme': 'vibrant', 'complexity': 'moderate'}")
