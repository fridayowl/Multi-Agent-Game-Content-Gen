...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250616_201827_medivial_spooky_game/ai_creative_assets/ai_textures/generic_spooky_78a28e73.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.8859489923750061
WIDTH_MULT = 1.0036642216613512
COMPLEXITY = "simple"
DETAIL_COUNT = 6
ASYMMETRY = 0.26725695575752306
...
def create_ai_unique_tombstone():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_tombstone_1"
...
def create_ai_rock():
    ...
    rock.name = f"AI_geometric_rock_1"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_geometric_bush_1"
