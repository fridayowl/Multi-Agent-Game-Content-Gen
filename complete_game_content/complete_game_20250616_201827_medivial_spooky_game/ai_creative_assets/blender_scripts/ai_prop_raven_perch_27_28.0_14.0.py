...
# Style Parameters: {'shape': 'angular', 'size': 'small', 'texture': 'smooth', 'color_scheme': 'monochrome', 'complexity': 'moderate'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250616_201827_medivial_spooky_game/ai_creative_assets/ai_textures/generic_spooky_abc23848.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.0870901346239368
WIDTH_MULT = 1.1434626237157783
COMPLEXITY = "medium"
DETAIL_COUNT = 2
ASYMMETRY = 0.24140878872044783
...
def create_ai_unique_raven_perch():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_raven_perch_27"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'angular', 'size': 'small', 'texture': 'smooth', 'color_scheme': 'monochrome', 'complexity': 'moderate'}")
