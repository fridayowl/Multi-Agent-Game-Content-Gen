...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250616_201827_medivial_spooky_game/ai_creative_assets/ai_textures/generic_spooky_14fecbc3.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.9412236994145089
WIDTH_MULT = 1.0273573835093905
COMPLEXITY = "medium"
DETAIL_COUNT = 6
ASYMMETRY = 0.37170498582057665
...
def create_ai_unique_tombstone():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_tombstone_60"
