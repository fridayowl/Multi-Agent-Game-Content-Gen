...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250616_201827_medivial_spooky_game/ai_creative_assets/ai_textures/generic_spooky_ca5586d9.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.0080367173294644
WIDTH_MULT = 1.1763216990386554
COMPLEXITY = "simple"
DETAIL_COUNT = 3
ASYMMETRY = 0.21187628768464978
...
def create_ai_unique_raven_perch():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_raven_perch_6"
