...
# Style Parameters: {'shape': 'geometric', 'size': 'large', 'texture': 'detailed', 'color_scheme': 'natural', 'complexity': 'moderate'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250616_201827_medivial_spooky_game/ai_creative_assets/ai_textures/generic_spooky_6add2b5e.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.8448848152248134
WIDTH_MULT = 1.2816417710813455
COMPLEXITY = "complex"
DETAIL_COUNT = 6
ASYMMETRY = 0.2445898771790303
...
def create_ai_unique_tombstone():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_tombstone_66"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'geometric', 'size': 'large', 'texture': 'detailed', 'color_scheme': 'natural', 'complexity': 'moderate'}")
