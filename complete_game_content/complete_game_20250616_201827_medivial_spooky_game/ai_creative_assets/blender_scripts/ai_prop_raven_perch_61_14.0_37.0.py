...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250616_201827_medivial_spooky_game/ai_creative_assets/ai_textures/generic_spooky_5aad51ac.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.4220528153339789
WIDTH_MULT = 1.1265619344105473
COMPLEXITY = "complex"
DETAIL_COUNT = 6
ASYMMETRY = 0.2812477198440202
...
def create_ai_unique_raven_perch():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_raven_perch_61"
...
def create_ai_rock():
    ...
    rock.name = f"AI_organic_rock_61"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_organic_bush_61"
