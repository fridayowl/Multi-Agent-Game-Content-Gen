...
# Style Parameters: {'shape': 'angular', 'size': 'large', 'texture': 'weathered', 'color_scheme': 'natural', 'complexity': 'moderate'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250616_201827_medivial_spooky_game/ai_creative_assets/ai_textures/generic_spooky_51e4432c.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.1730222481663715
WIDTH_MULT = 1.0108496367317559
COMPLEXITY = "simple"
DETAIL_COUNT = 6
ASYMMETRY = 0.23362941276213936
...
def create_ai_unique_raven_perch():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_raven_perch_58"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'angular', 'size': 'large', 'texture': 'weathered', 'color_scheme': 'natural', 'complexity': 'moderate'}")
