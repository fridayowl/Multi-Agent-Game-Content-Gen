...
# Style Parameters: {'trunk_style': 'gnarled', 'canopy_shape': 'sparse', 'branch_density': 'dense', 'leaf_type': 'none', 'seasonal_state': 'dead', 'bark_texture': 'cracked', 'height_variation': 'tall'}
...
# AI Texture paths
ai_textures = {"bark": "complete_game_content/complete_game_20250616_201827_medivial_spooky_game/ai_creative_assets/ai_textures/wood_spooky_13c91bf4.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.2199652741538611
WIDTH_MULT = 0.8165415486696435
COMPLEXITY = "medium"
DETAIL_COUNT = 5
ASYMMETRY = 0.35904683392360226
...
try:
    ...
    print(f"🎨 Style: {'trunk_style': 'gnarled', 'canopy_shape': 'sparse', 'branch_density': 'dense', 'leaf_type': 'none', 'seasonal_state': 'dead', 'bark_texture': 'cracked', 'height_variation': 'tall'}")
