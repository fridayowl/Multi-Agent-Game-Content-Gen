...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250616_201827_medivial_spooky_game/ai_creative_assets/ai_textures/generic_spooky_d5fb6482.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.2695457560272616
WIDTH_MULT = 0.9801810069121886
COMPLEXITY = "medium"
DETAIL_COUNT = 4
ASYMMETRY = 0.35338346495344797
...
def create_ai_unique_tombstone():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_tombstone_33"
...
def create_ai_rock():
    ...
    rock.name = f"AI_organic_rock_33"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_organic_bush_33"
