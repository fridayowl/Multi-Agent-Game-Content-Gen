...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250616_201827_medivial_spooky_game/ai_creative_assets/ai_textures/generic_spooky_9704a43d.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.01188158828788
WIDTH_MULT = 0.8823339606416569
COMPLEXITY = "medium"
DETAIL_COUNT = 3
ASYMMETRY = 0.12712367259399718
...
def create_ai_unique_raven_perch():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_raven_perch_63"
...
def create_ai_rock():
    ...
    rock.name = f"AI_geometric_rock_63"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_geometric_bush_63"
