...
# Style Parameters: {'shape': 'geometric', 'size': 'medium', 'texture': 'smooth', 'color_scheme': 'natural', 'complexity': 'complex'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_163425_Generate_a_desert_oasis_tradin/ai_creative_assets/ai_textures/generic_desert_ca42e2d4.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.9897034535000437
WIDTH_MULT = 0.9765763772813655
COMPLEXITY = "complex"
DETAIL_COUNT = 4
ASYMMETRY = 0.20788395751106606
...
def create_ai_unique_sand_dune():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_sand_dune_80"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'geometric', 'size': 'medium', 'texture': 'smooth', 'color_scheme': 'natural', 'complexity': 'complex'}")
