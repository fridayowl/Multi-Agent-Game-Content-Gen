...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_163425_Generate_a_desert_oasis_tradin/ai_creative_assets/ai_textures/generic_desert_468e4cf7.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.1828282650932305
WIDTH_MULT = 0.9463120418545719
COMPLEXITY = "medium"
DETAIL_COUNT = 6
ASYMMETRY = 0.1635325829552749
...
def create_ai_unique_desert_flower():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_desert_flower_54"
