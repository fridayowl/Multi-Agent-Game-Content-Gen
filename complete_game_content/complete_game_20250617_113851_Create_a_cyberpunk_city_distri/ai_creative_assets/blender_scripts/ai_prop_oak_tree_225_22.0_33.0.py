...
# Style Parameters: {'trunk_style': 'split', 'canopy_shape': 'oval', 'branch_density': 'medium', 'leaf_type': 'broad', 'seasonal_state': 'spring', 'bark_texture': 'scarred', 'height_variation': 'ancient'}
...
def create_ai_unique_oak_tree():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_oak_tree_225"
...
def create_ai_tree():
    ...
    if trunk_style == "twisted":
        ...
        for i in range(max(2, DETAIL_COUNT // 2)):
            ...
            segment.name = f"AI_twisted_segment_{i}_225"
        ...
        trunk.name = f"AI_gnarled_trunk_225"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_split_main_225"
        ...
        for i in range(2):
            ...
            branch.name = f"AI_split_branch_{i}_225"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_straight_trunk_225"
        tree_parts.append(trunk)
    ...
    if canopy_shape == "round":
        ...
        canopy.name = f"AI_round_canopy_225"
        ...
        canopy.name = f"AI_oval_canopy_225"
        tree_parts.append(canopy)
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere.name = f"AI_irregular_canopy_{i}_225"
        ...
        for i in range(cluster_count):
            ...
            cluster.name = f"AI_sparse_cluster_{i}_225"
        ...
        for i in range(frond_count):
            ...
            frond.name = f"AI_palm_frond_{i}_225"
        ...
        canopy = bpy.context.active_object
        canopy.name = f"AI_default_canopy_225"
        tree_parts.append(canopy)
...
def create_ai_rock():
    ...
    if rock_shape == "angular":
        ...
        for i in range(DETAIL_COUNT // 2):
            ...
            crystal.name = f"AI_crystal_{i}_225"
    ...
    rock.name = f"AI_rounded_rock_225"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere = bpy.context.active_object
            sphere.name = f"AI_spreading_bush_{i}_225"
...
def create_ai_generic_prop():
    ...
    prop.name = f"AI_generic_prop_225"
...
try:
    ...
    print(f"🎨 Style: {'trunk_style': 'split', 'canopy_shape': 'oval', 'branch_density': 'medium', 'leaf_type': 'broad', 'seasonal_state': 'spring', 'bark_texture': 'scarred', 'height_variation': 'ancient'}")
