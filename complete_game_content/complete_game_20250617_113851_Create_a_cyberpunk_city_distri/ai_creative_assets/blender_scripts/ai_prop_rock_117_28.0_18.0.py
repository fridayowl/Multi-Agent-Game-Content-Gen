...
# Style Parameters: {'shape': 'crystalline', 'surface': 'mossy', 'size_category': 'small', 'formation': 'single', 'weathering': 'fresh', 'mineral_type': 'limestone'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_113851_Create_a_cyberpunk_city_distri/ai_creative_assets/ai_textures/stone_modern_33579577.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.9870131469775921
WIDTH_MULT = 1.009807497945308
COMPLEXITY = "complex"
DETAIL_COUNT = 3
ASYMMETRY = 0.1556293488712456
...
def create_ai_tree():
    ...
    if trunk_style == "twisted":
        ...
        for i in range(max(2, DETAIL_COUNT // 2)):
            ...
            segment.name = f"AI_twisted_segment_{i}_117"
        ...
        trunk.name = f"AI_gnarled_trunk_117"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_split_main_117"
        ...
        for i in range(2):
            ...
            branch.name = f"AI_split_branch_{i}_117"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_straight_trunk_117"
        tree_parts.append(trunk)
    ...
    if canopy_shape == "round":
        ...
        canopy.name = f"AI_round_canopy_117"
        ...
        canopy.name = f"AI_oval_canopy_117"
        tree_parts.append(canopy)
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere.name = f"AI_irregular_canopy_{i}_117"
        ...
        for i in range(cluster_count):
            ...
            cluster.name = f"AI_sparse_cluster_{i}_117"
        ...
        for i in range(frond_count):
            ...
            frond.name = f"AI_palm_frond_{i}_117"
        ...
        canopy = bpy.context.active_object
        canopy.name = f"AI_default_canopy_117"
        tree_parts.append(canopy)
...
def create_ai_rock():
    ...
    if rock_shape == "angular":
        ...
        for i in range(DETAIL_COUNT // 2):
            ...
            crystal.name = f"AI_crystal_{i}_117"
    ...
    rock.name = f"AI_crystalline_rock_117"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere = bpy.context.active_object
            sphere.name = f"AI_spreading_bush_{i}_117"
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_crystalline_bush_117"
...
def create_ai_generic_prop():
    ...
    prop.name = f"AI_generic_prop_117"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'crystalline', 'surface': 'mossy', 'size_category': 'small', 'formation': 'single', 'weathering': 'fresh', 'mineral_type': 'limestone'}")
