...
# Style Parameters: {'shape': 'oval', 'density': 'overgrown', 'leaf_size': 'medium', 'flowering': 'year_round', 'berry_type': 'blue', 'thorns': 'light'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_113851_Create_a_cyberpunk_city_distri/ai_creative_assets/ai_textures/foliage_modern_8359eb55.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.9975141383175535
WIDTH_MULT = 0.9397566815348879
COMPLEXITY = "complex"
DETAIL_COUNT = 2
ASYMMETRY = 0.24128099839441997
...
try:
    ...
    print(f"🎨 Style: {'shape': 'oval', 'density': 'overgrown', 'leaf_size': 'medium', 'flowering': 'year_round', 'berry_type': 'blue', 'thorns': 'light'}")
