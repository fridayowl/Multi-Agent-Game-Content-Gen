...
# Style Parameters: {'trunk_style': 'split', 'canopy_shape': 'sparse', 'branch_density': 'dense', 'leaf_type': 'broad', 'seasonal_state': 'spring', 'bark_texture': 'deeply_furrowed', 'height_variation': 'normal'}
...
# AI Texture paths
ai_textures = {"bark": "complete_game_content/complete_game_20250617_113851_Create_a_cyberpunk_city_distri/ai_creative_assets/ai_textures/wood_modern_abb1c56c.png", "leaves": "complete_game_content/complete_game_20250617_113851_Create_a_cyberpunk_city_distri/ai_creative_assets/ai_textures/foliage_modern_885cf3ec.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 2.481147502635374
WIDTH_MULT = 0.8138014586709423
COMPLEXITY = "complex"
DETAIL_COUNT = 2
ASYMMETRY = 0.2944596368645269
...
def create_ai_unique_oak_tree():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_oak_tree_265"
...
def create_ai_tree():
    ...
    if trunk_style == "twisted":
        ...
        for i in range(max(2, DETAIL_COUNT // 2)):
            ...
            segment.name = f"AI_twisted_segment_{i}_265"
        ...
        trunk.name = f"AI_gnarled_trunk_265"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_split_main_265"
        ...
        for i in range(2):
            ...
            branch.name = f"AI_split_branch_{i}_265"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_straight_trunk_265"
        tree_parts.append(trunk)
    ...
    if canopy_shape == "round":
        ...
        canopy.name = f"AI_round_canopy_265"
        ...
        canopy.name = f"AI_oval_canopy_265"
        tree_parts.append(canopy)
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere.name = f"AI_irregular_canopy_{i}_265"
        ...
        for i in range(cluster_count):
            ...
            cluster.name = f"AI_sparse_cluster_{i}_265"
        ...
        for i in range(frond_count):
            ...
            frond.name = f"AI_palm_frond_{i}_265"
        ...
        canopy = bpy.context.active_object
        canopy.name = f"AI_default_canopy_265"
        tree_parts.append(canopy)
...
def create_ai_rock():
    ...
    if rock_shape == "angular":
        ...
        for i in range(DETAIL_COUNT // 2):
            ...
            crystal.name = f"AI_crystal_{i}_265"
    ...
    rock.name = f"AI_rounded_rock_265"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere = bpy.context.active_object
            sphere.name = f"AI_spreading_bush_{i}_265"
...
def create_ai_generic_prop():
    ...
    prop.name = f"AI_generic_prop_265"
...
try:
    ...
    print(f"🎨 Style: {'trunk_style': 'split', 'canopy_shape': 'sparse', 'branch_density': 'dense', 'leaf_type': 'broad', 'seasonal_state': 'spring', 'bark_texture': 'deeply_furrowed', 'height_variation': 'normal'}")
