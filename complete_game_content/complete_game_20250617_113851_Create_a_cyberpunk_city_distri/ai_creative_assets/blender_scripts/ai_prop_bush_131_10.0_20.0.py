...
# Style Parameters: {'shape': 'oval', 'density': 'sparse', 'leaf_size': 'small', 'flowering': 'spring', 'berry_type': 'black', 'thorns': 'heavy'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_113851_Create_a_cyberpunk_city_distri/ai_creative_assets/ai_textures/foliage_modern_5ef9678b.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.9582498133514112
WIDTH_MULT = 1.1079175512964046
COMPLEXITY = "simple"
DETAIL_COUNT = 3
ASYMMETRY = 0.22271461809263024
...
def create_ai_tree():
    ...
    if trunk_style == "twisted":
        ...
        for i in range(max(2, DETAIL_COUNT // 2)):
            ...
            segment.name = f"AI_twisted_segment_{i}_131"
        ...
        trunk.name = f"AI_gnarled_trunk_131"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_split_main_131"
        ...
        for i in range(2):
            ...
            branch.name = f"AI_split_branch_{i}_131"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_straight_trunk_131"
        tree_parts.append(trunk)
    ...
    if canopy_shape == "round":
        ...
        canopy.name = f"AI_round_canopy_131"
        ...
        canopy.name = f"AI_oval_canopy_131"
        tree_parts.append(canopy)
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere.name = f"AI_irregular_canopy_{i}_131"
        ...
        for i in range(cluster_count):
            ...
            cluster.name = f"AI_sparse_cluster_{i}_131"
        ...
        for i in range(frond_count):
            ...
            frond.name = f"AI_palm_frond_{i}_131"
        ...
        canopy = bpy.context.active_object
        canopy.name = f"AI_default_canopy_131"
        tree_parts.append(canopy)
...
def create_ai_rock():
    ...
    if rock_shape == "angular":
        ...
        for i in range(DETAIL_COUNT // 2):
            ...
            crystal.name = f"AI_crystal_{i}_131"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere = bpy.context.active_object
            sphere.name = f"AI_spreading_bush_{i}_131"
...
def create_ai_generic_prop():
    ...
    prop.name = f"AI_generic_prop_131"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'oval', 'density': 'sparse', 'leaf_size': 'small', 'flowering': 'spring', 'berry_type': 'black', 'thorns': 'heavy'}")
