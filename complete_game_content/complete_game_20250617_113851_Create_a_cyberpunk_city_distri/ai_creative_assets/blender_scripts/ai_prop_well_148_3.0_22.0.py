...
# Style Parameters: {'construction': 'brick', 'roof_style': 'tiled', 'bucket_system': 'chain', 'water_level': 'dry', 'decoration': 'ivy_covered', 'age': 'new'}
...
# AI Texture paths
ai_textures = {"stone": "complete_game_content/complete_game_20250617_113851_Create_a_cyberpunk_city_distri/ai_creative_assets/ai_textures/stone_modern_9d7138e0.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.9587117625408841
WIDTH_MULT = 0.8069022937822101
COMPLEXITY = "complex"
DETAIL_COUNT = 4
ASYMMETRY = 0.30381922270513484
...
def create_ai_tree():
    ...
    if trunk_style == "twisted":
        ...
        for i in range(max(2, DETAIL_COUNT // 2)):
            ...
            segment.name = f"AI_twisted_segment_{i}_148"
        ...
        trunk.name = f"AI_gnarled_trunk_148"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_split_main_148"
        ...
        for i in range(2):
            ...
            branch.name = f"AI_split_branch_{i}_148"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_straight_trunk_148"
        tree_parts.append(trunk)
    ...
    if canopy_shape == "round":
        ...
        canopy.name = f"AI_round_canopy_148"
        ...
        canopy.name = f"AI_oval_canopy_148"
        tree_parts.append(canopy)
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere.name = f"AI_irregular_canopy_{i}_148"
        ...
        for i in range(cluster_count):
            ...
            cluster.name = f"AI_sparse_cluster_{i}_148"
        ...
        for i in range(frond_count):
            ...
            frond.name = f"AI_palm_frond_{i}_148"
        ...
        canopy = bpy.context.active_object
        canopy.name = f"AI_default_canopy_148"
        tree_parts.append(canopy)
...
def create_ai_rock():
    ...
    if rock_shape == "angular":
        ...
        for i in range(DETAIL_COUNT // 2):
            ...
            crystal.name = f"AI_crystal_{i}_148"
    ...
    rock.name = f"AI_rounded_rock_148"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere = bpy.context.active_object
            sphere.name = f"AI_spreading_bush_{i}_148"
...
def create_ai_generic_prop():
    ...
    prop.name = f"AI_generic_prop_148"
...
try:
    ...
    print(f"🎨 Style: {'construction': 'brick', 'roof_style': 'tiled', 'bucket_system': 'chain', 'water_level': 'dry', 'decoration': 'ivy_covered', 'age': 'new'}")
