...
# Style Parameters: {'construction': 'stone', 'roof_style': 'wooden', 'bucket_system': 'crank', 'water_level': 'low', 'decoration': 'ivy_covered', 'age': 'crumbling'}
...
# AI Texture paths
ai_textures = {"stone": "complete_game_content/complete_game_20250617_113851_Create_a_cyberpunk_city_distri/ai_creative_assets/ai_textures/stone_modern_34f45df3.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.1751906982619182
WIDTH_MULT = 1.0016241332665028
COMPLEXITY = "simple"
DETAIL_COUNT = 3
ASYMMETRY = 0.36849486862615277
...
def create_ai_rock():
    ...
    rock.name = f"AI_rounded_rock_61"
...
try:
    ...
    print(f"🎨 Style: {'construction': 'stone', 'roof_style': 'wooden', 'bucket_system': 'crank', 'water_level': 'low', 'decoration': 'ivy_covered', 'age': 'crumbling'}")
