...
# Style Parameters: {'shape': 'flat', 'surface': 'cracked', 'size_category': 'large', 'formation': 'outcrop', 'weathering': 'ancient', 'mineral_type': 'granite'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_113851_Create_a_cyberpunk_city_distri/ai_creative_assets/ai_textures/stone_modern_90ecdb9f.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.5565410601335447
WIDTH_MULT = 1.350666158726952
COMPLEXITY = "simple"
DETAIL_COUNT = 6
ASYMMETRY = 0.15828666918479978
...
try:
    ...
    print(f"🎨 Style: {'shape': 'flat', 'surface': 'cracked', 'size_category': 'large', 'formation': 'outcrop', 'weathering': 'ancient', 'mineral_type': 'granite'}")
