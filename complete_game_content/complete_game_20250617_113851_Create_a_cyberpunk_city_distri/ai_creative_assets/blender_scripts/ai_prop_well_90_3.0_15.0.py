...
# Style Parameters: {'construction': 'metal', 'roof_style': 'none', 'bucket_system': 'chain', 'water_level': 'medium', 'decoration': 'carved', 'age': 'ancient'}
...
# AI Texture paths
ai_textures = {"stone": "complete_game_content/complete_game_20250617_113851_Create_a_cyberpunk_city_distri/ai_creative_assets/ai_textures/stone_modern_3a1d49ff.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.371927049155538
WIDTH_MULT = 1.055925481487151
COMPLEXITY = "simple"
DETAIL_COUNT = 4
ASYMMETRY = 0.1252294475195716
...
try:
    ...
    print(f"🎨 Style: {'construction': 'metal', 'roof_style': 'none', 'bucket_system': 'chain', 'water_level': 'medium', 'decoration': 'carved', 'age': 'ancient'}")
