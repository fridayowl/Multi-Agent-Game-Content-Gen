...
# Style Parameters: {'shape': 'flat', 'surface': 'cracked', 'size_category': 'boulder', 'formation': 'single', 'weathering': 'ancient', 'mineral_type': 'sandstone'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_113851_Create_a_cyberpunk_city_distri/ai_creative_assets/ai_textures/stone_modern_351ce7e7.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.5767960865412254
WIDTH_MULT = 1.1046227599535032
COMPLEXITY = "simple"
DETAIL_COUNT = 5
ASYMMETRY = 0.3789491813618302
...
def create_ai_tree():
    ...
    if trunk_style == "twisted":
        ...
        for i in range(max(2, DETAIL_COUNT // 2)):
            ...
            segment.name = f"AI_twisted_segment_{i}_260"
        ...
        trunk.name = f"AI_gnarled_trunk_260"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_split_main_260"
        ...
        for i in range(2):
            ...
            branch.name = f"AI_split_branch_{i}_260"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_straight_trunk_260"
        tree_parts.append(trunk)
    ...
    if canopy_shape == "round":
        ...
        canopy.name = f"AI_round_canopy_260"
        ...
        canopy.name = f"AI_oval_canopy_260"
        tree_parts.append(canopy)
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere.name = f"AI_irregular_canopy_{i}_260"
        ...
        for i in range(cluster_count):
            ...
            cluster.name = f"AI_sparse_cluster_{i}_260"
        ...
        for i in range(frond_count):
            ...
            frond.name = f"AI_palm_frond_{i}_260"
        ...
        canopy = bpy.context.active_object
        canopy.name = f"AI_default_canopy_260"
        tree_parts.append(canopy)
...
def create_ai_rock():
    ...
    if rock_shape == "angular":
        ...
        for i in range(DETAIL_COUNT // 2):
            ...
            crystal.name = f"AI_crystal_{i}_260"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere = bpy.context.active_object
            sphere.name = f"AI_spreading_bush_{i}_260"
...
def create_ai_generic_prop():
    ...
    prop.name = f"AI_generic_prop_260"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'flat', 'surface': 'cracked', 'size_category': 'boulder', 'formation': 'single', 'weathering': 'ancient', 'mineral_type': 'sandstone'}")
