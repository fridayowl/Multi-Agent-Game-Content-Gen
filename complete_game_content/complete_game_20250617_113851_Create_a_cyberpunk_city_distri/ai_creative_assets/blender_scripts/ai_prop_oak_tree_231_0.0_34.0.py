...
# Style Parameters: {'trunk_style': 'split', 'canopy_shape': 'round', 'branch_density': 'dense', 'leaf_type': 'broad', 'seasonal_state': 'winter', 'bark_texture': 'deeply_furrowed', 'height_variation': 'tall'}
...
# AI Texture paths
ai_textures = {"bark": "complete_game_content/complete_game_20250617_113851_Create_a_cyberpunk_city_distri/ai_creative_assets/ai_textures/wood_modern_b7b4c324.png", "leaves": "complete_game_content/complete_game_20250617_113851_Create_a_cyberpunk_city_distri/ai_creative_assets/ai_textures/foliage_modern_862cdbd5.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 2.4554250140967584
WIDTH_MULT = 0.8323751879626866
COMPLEXITY = "medium"
DETAIL_COUNT = 3
ASYMMETRY = 0.3015302850746764
...
def create_ai_unique_oak_tree():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_oak_tree_231"
...
def create_ai_tree():
    ...
    if trunk_style == "twisted":
        ...
        for i in range(max(2, DETAIL_COUNT // 2)):
            ...
            segment.name = f"AI_twisted_segment_{i}_231"
        ...
        trunk.name = f"AI_gnarled_trunk_231"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_split_main_231"
        ...
        for i in range(2):
            ...
            branch.name = f"AI_split_branch_{i}_231"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_straight_trunk_231"
        tree_parts.append(trunk)
    ...
    if canopy_shape == "round":
        ...
        canopy.name = f"AI_round_canopy_231"
        ...
        canopy.name = f"AI_oval_canopy_231"
        tree_parts.append(canopy)
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere.name = f"AI_irregular_canopy_{i}_231"
        ...
        for i in range(cluster_count):
            ...
            cluster.name = f"AI_sparse_cluster_{i}_231"
        ...
        for i in range(frond_count):
            ...
            frond.name = f"AI_palm_frond_{i}_231"
        ...
        canopy = bpy.context.active_object
        canopy.name = f"AI_default_canopy_231"
        tree_parts.append(canopy)
...
def create_ai_rock():
    ...
    if rock_shape == "angular":
        ...
        for i in range(DETAIL_COUNT // 2):
            ...
            crystal.name = f"AI_crystal_{i}_231"
    ...
    rock.name = f"AI_rounded_rock_231"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere = bpy.context.active_object
            sphere.name = f"AI_spreading_bush_{i}_231"
...
def create_ai_generic_prop():
    ...
    prop.name = f"AI_generic_prop_231"
...
try:
    ...
    print(f"🎨 Style: {'trunk_style': 'split', 'canopy_shape': 'round', 'branch_density': 'dense', 'leaf_type': 'broad', 'seasonal_state': 'winter', 'bark_texture': 'deeply_furrowed', 'height_variation': 'tall'}")
