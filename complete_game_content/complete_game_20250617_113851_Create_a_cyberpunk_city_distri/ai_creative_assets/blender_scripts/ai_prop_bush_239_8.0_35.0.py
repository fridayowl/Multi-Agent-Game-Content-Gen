...
# Style Parameters: {'shape': 'oval', 'density': 'thick', 'leaf_size': 'small', 'flowering': 'year_round', 'berry_type': 'red', 'thorns': 'heavy'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_113851_Create_a_cyberpunk_city_distri/ai_creative_assets/ai_textures/foliage_modern_05a76d6b.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.0718611872102746
WIDTH_MULT = 0.9909407297997276
COMPLEXITY = "complex"
DETAIL_COUNT = 4
ASYMMETRY = 0.11380568294868215
...
def create_ai_tree():
    ...
    if trunk_style == "twisted":
        ...
        for i in range(max(2, DETAIL_COUNT // 2)):
            ...
            segment.name = f"AI_twisted_segment_{i}_239"
        ...
        trunk.name = f"AI_gnarled_trunk_239"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_split_main_239"
        ...
        for i in range(2):
            ...
            branch.name = f"AI_split_branch_{i}_239"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_straight_trunk_239"
        tree_parts.append(trunk)
    ...
    if canopy_shape == "round":
        ...
        canopy.name = f"AI_round_canopy_239"
        ...
        canopy.name = f"AI_oval_canopy_239"
        tree_parts.append(canopy)
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere.name = f"AI_irregular_canopy_{i}_239"
        ...
        for i in range(cluster_count):
            ...
            cluster.name = f"AI_sparse_cluster_{i}_239"
        ...
        for i in range(frond_count):
            ...
            frond.name = f"AI_palm_frond_{i}_239"
        ...
        canopy = bpy.context.active_object
        canopy.name = f"AI_default_canopy_239"
        tree_parts.append(canopy)
...
def create_ai_rock():
    ...
    if rock_shape == "angular":
        ...
        for i in range(DETAIL_COUNT // 2):
            ...
            crystal.name = f"AI_crystal_{i}_239"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere = bpy.context.active_object
            sphere.name = f"AI_spreading_bush_{i}_239"
...
def create_ai_generic_prop():
    ...
    prop.name = f"AI_generic_prop_239"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'oval', 'density': 'thick', 'leaf_size': 'small', 'flowering': 'year_round', 'berry_type': 'red', 'thorns': 'heavy'}")
