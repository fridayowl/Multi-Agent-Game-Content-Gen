...
# Style Parameters: {'shape': 'upright', 'density': 'sparse', 'leaf_size': 'small', 'flowering': 'summer', 'berry_type': 'black', 'thorns': 'light'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_113851_Create_a_cyberpunk_city_distri/ai_creative_assets/ai_textures/foliage_modern_583d9cc6.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.1939828439250926
WIDTH_MULT = 0.8459452398548923
COMPLEXITY = "complex"
DETAIL_COUNT = 3
ASYMMETRY = 0.20433342652195732
...
def create_ai_tree():
    ...
    if trunk_style == "twisted":
        ...
        for i in range(max(2, DETAIL_COUNT // 2)):
            ...
            segment.name = f"AI_twisted_segment_{i}_123"
        ...
        trunk.name = f"AI_gnarled_trunk_123"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_split_main_123"
        ...
        for i in range(2):
            ...
            branch.name = f"AI_split_branch_{i}_123"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_straight_trunk_123"
        tree_parts.append(trunk)
    ...
    if canopy_shape == "round":
        ...
        canopy.name = f"AI_round_canopy_123"
        ...
        canopy.name = f"AI_oval_canopy_123"
        tree_parts.append(canopy)
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere.name = f"AI_irregular_canopy_{i}_123"
        ...
        for i in range(cluster_count):
            ...
            cluster.name = f"AI_sparse_cluster_{i}_123"
        ...
        for i in range(frond_count):
            ...
            frond.name = f"AI_palm_frond_{i}_123"
        ...
        canopy = bpy.context.active_object
        canopy.name = f"AI_default_canopy_123"
        tree_parts.append(canopy)
...
def create_ai_rock():
    ...
    if rock_shape == "angular":
        ...
        for i in range(DETAIL_COUNT // 2):
            ...
            crystal.name = f"AI_crystal_{i}_123"
    ...
    rock.name = f"AI_upright_rock_123"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere = bpy.context.active_object
            sphere.name = f"AI_spreading_bush_{i}_123"
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_upright_bush_123"
...
def create_ai_generic_prop():
    ...
    prop.name = f"AI_generic_prop_123"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'upright', 'density': 'sparse', 'leaf_size': 'small', 'flowering': 'summer', 'berry_type': 'black', 'thorns': 'light'}")
