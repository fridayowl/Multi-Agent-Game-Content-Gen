...
# Style Parameters: {'shape': 'spreading', 'density': 'overgrown', 'leaf_size': 'small', 'flowering': 'year_round', 'berry_type': 'black', 'thorns': 'none'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_113851_Create_a_cyberpunk_city_distri/ai_creative_assets/ai_textures/foliage_modern_55525122.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.211301837776066
WIDTH_MULT = 0.8666391136381741
COMPLEXITY = "medium"
DETAIL_COUNT = 6
ASYMMETRY = 0.2560435677988695
...
def create_ai_tree():
    ...
    if trunk_style == "twisted":
        ...
        for i in range(max(2, DETAIL_COUNT // 2)):
            ...
            segment.name = f"AI_twisted_segment_{i}_250"
        ...
        trunk.name = f"AI_gnarled_trunk_250"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_split_main_250"
        ...
        for i in range(2):
            ...
            branch.name = f"AI_split_branch_{i}_250"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_straight_trunk_250"
        tree_parts.append(trunk)
    ...
    if canopy_shape == "round":
        ...
        canopy.name = f"AI_round_canopy_250"
        ...
        canopy.name = f"AI_oval_canopy_250"
        tree_parts.append(canopy)
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere.name = f"AI_irregular_canopy_{i}_250"
        ...
        for i in range(cluster_count):
            ...
            cluster.name = f"AI_sparse_cluster_{i}_250"
        ...
        for i in range(frond_count):
            ...
            frond.name = f"AI_palm_frond_{i}_250"
        ...
        canopy = bpy.context.active_object
        canopy.name = f"AI_default_canopy_250"
        tree_parts.append(canopy)
...
def create_ai_rock():
    ...
    if rock_shape == "angular":
        ...
        for i in range(DETAIL_COUNT // 2):
            ...
            crystal.name = f"AI_crystal_{i}_250"
    ...
    rock.name = f"AI_spreading_rock_250"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere = bpy.context.active_object
            sphere.name = f"AI_spreading_bush_{i}_250"
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_spreading_bush_250"
...
def create_ai_generic_prop():
    ...
    prop.name = f"AI_generic_prop_250"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'spreading', 'density': 'overgrown', 'leaf_size': 'small', 'flowering': 'year_round', 'berry_type': 'black', 'thorns': 'none'}")
