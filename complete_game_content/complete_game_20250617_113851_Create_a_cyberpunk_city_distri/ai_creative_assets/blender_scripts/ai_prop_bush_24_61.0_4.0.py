...
# Style Parameters: {'shape': 'spreading', 'density': 'overgrown', 'leaf_size': 'medium', 'flowering': 'year_round', 'berry_type': 'purple', 'thorns': 'none'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_113851_Create_a_cyberpunk_city_distri/ai_creative_assets/ai_textures/foliage_modern_9d0b8d74.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.3554123803032476
WIDTH_MULT = 1.0660143830333095
COMPLEXITY = "medium"
DETAIL_COUNT = 3
ASYMMETRY = 0.36530034692689184
...
def create_ai_tree():
    ...
    if trunk_style == "twisted":
        ...
        for i in range(max(2, DETAIL_COUNT // 2)):
            ...
            bpy.ops.mesh.primitive_cylinder_add(
                ...
                location=(61.0, 4.0, i * segment_height + segment_height/2)
            )
        ...
        bpy.ops.mesh.primitive_cylinder_add(
            ...
            location=(61.0, 4.0, trunk_height * 0.4)
        )
        ...
        bpy.ops.mesh.primitive_cylinder_add(
            ...
            location=(61.0, 4.0, trunk_height * 0.3)
        )
        trunk = bpy.context.active_object
        ...
        for i in range(2):
            ...
            bpy.ops.mesh.primitive_cylinder_add(
                ...
                location=(61.0 + offset_x, 4.0 + offset_y, trunk_height * 0.75)
            )
        ...
        bpy.ops.mesh.primitive_cylinder_add(
            ...
            radius=trunk_radius,
            depth=trunk_height,
            location=(61.0, 4.0, trunk_height/2)
        )
        trunk = bpy.context.active_object
    ...
    if canopy_shape == "round":
        bpy.ops.mesh.primitive_ico_sphere_add(
            subdivisions=2,
            radius=canopy_size,
            location=(61.0, 4.0, canopy_height)
        )
        ...
        for i in range(DETAIL_COUNT):
            ...
            bpy.ops.mesh.primitive_ico_sphere_add(
                subdivisions=1,
                radius=size,
                location=(61.0 + offset_x, 4.0 + offset_y, canopy_height + offset_z)
            )
...
def create_ai_rock():
    ...
    if rock_shape == "angular":
        bpy.ops.mesh.primitive_cube_add(
            size=base_size,
            location=(61.0, 4.0, rock_height/2)
        )
        ...
        bpy.ops.mesh.primitive_cone_add(
            ...
            location=(61.0, 4.0, rock_height * 0.75)
        )
        rock = bpy.context.active_object
        ...
        for i in range(DETAIL_COUNT // 2):
            ...
            bpy.ops.mesh.primitive_cone_add(
                ...
                location=(61.0 + offset_x, 4.0 + offset_y, rock_height * 0.35)
            )
    ...
    rock.name = f"AI_spreading_rock_24"
    ...
    if bush_shape == "spreading":
        ...
        for i in range(DETAIL_COUNT):
            ...
            bpy.ops.mesh.primitive_ico_sphere_add(
                subdivisions=1,
                radius=sphere_size,
                location=(61.0 + offset_x, 4.0 + offset_y, bush_height * 0.4)
            )
            sphere = bpy.context.active_object
        ...
        bpy.ops.mesh.primitive_ico_sphere_add(
            subdivisions=2,
            radius=bush_size,
            location=(61.0, 4.0, bush_height/2)
        )
        bush = bpy.context.active_object
        bush.scale = (1.0, 1.0, bush_height)
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_spreading_bush_24"
...
def create_ai_well():
    ...
    bpy.ops.mesh.primitive_cylinder_add(
        ...
        location=(61.0, 4.0, 0.5 * HEIGHT_MULT)
    )
    ...
    if random.random() > 0.5:  # 50% chance of roof
        bpy.ops.mesh.primitive_cone_add(
            ...
            radius2=0.1,
            depth=0.8,
            location=(61.0, 4.0, HEIGHT_MULT + 0.4)
        )
...
try:
    ...
    print(f"🎨 Style: {'shape': 'spreading', 'density': 'overgrown', 'leaf_size': 'medium', 'flowering': 'year_round', 'berry_type': 'purple', 'thorns': 'none'}")
