...
# Style Parameters: {'shape': 'angular', 'surface': 'cracked', 'size_category': 'large', 'formation': 'cluster', 'weathering': 'eroded', 'mineral_type': 'basalt'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_104158_medivial_game/ai_creative_assets/ai_textures/stone_medieval_af7d5311.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.5915020133262006
WIDTH_MULT = 1.2767323993911066
COMPLEXITY = "simple"
DETAIL_COUNT = 4
ASYMMETRY = 0.34796224460773667
...
try:
    ...
    print(f"🎨 Style: {'shape': 'angular', 'surface': 'cracked', 'size_category': 'large', 'formation': 'cluster', 'weathering': 'eroded', 'mineral_type': 'basalt'}")
