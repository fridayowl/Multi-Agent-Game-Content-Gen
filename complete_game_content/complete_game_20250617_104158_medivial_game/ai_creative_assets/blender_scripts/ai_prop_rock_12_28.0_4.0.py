...
# Style Parameters: {'shape': 'crystalline', 'surface': 'rough', 'size_category': 'small', 'formation': 'outcrop', 'weathering': 'fresh', 'mineral_type': 'granite'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_104158_medivial_game/ai_creative_assets/ai_textures/stone_medieval_debb35f9.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.0618791270048544
WIDTH_MULT = 1.4280927849882663
COMPLEXITY = "simple"
DETAIL_COUNT = 3
ASYMMETRY = 0.30271227618547625
...
def create_ai_rock():
    ...
    rock.name = f"AI_crystalline_rock_12"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_crystalline_bush_12"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'crystalline', 'surface': 'rough', 'size_category': 'small', 'formation': 'outcrop', 'weathering': 'fresh', 'mineral_type': 'granite'}")
