...
# Style Parameters: {'shape': 'oval', 'density': 'thick', 'leaf_size': 'small', 'flowering': 'year_round', 'berry_type': 'red', 'thorns': 'none'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_104158_medivial_game/ai_creative_assets/ai_textures/foliage_medieval_ec12561c.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.9051794221023257
WIDTH_MULT = 0.9356960715947096
COMPLEXITY = "complex"
DETAIL_COUNT = 3
ASYMMETRY = 0.35059741343656525
...
try:
    ...
    print(f"🎨 Style: {'shape': 'oval', 'density': 'thick', 'leaf_size': 'small', 'flowering': 'year_round', 'berry_type': 'red', 'thorns': 'none'}")
