...
# Style Parameters: {'trunk_style': 'gnarled', 'canopy_shape': 'round', 'branch_density': 'medium', 'leaf_type': 'broad', 'seasonal_state': 'winter', 'bark_texture': 'deeply_furrowed', 'height_variation': 'normal'}
...
# AI Texture paths
ai_textures = {"bark": "complete_game_content/complete_game_20250617_104158_medivial_game/ai_creative_assets/ai_textures/wood_medieval_4b47f6c1.png", "leaves": "complete_game_content/complete_game_20250617_104158_medivial_game/ai_creative_assets/ai_textures/foliage_medieval_6db2b37b.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 2.3282614875153786
WIDTH_MULT = 0.9172696300557953
COMPLEXITY = "complex"
DETAIL_COUNT = 5
ASYMMETRY = 0.1796000196070321
...
def create_ai_unique_oak_tree():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_oak_tree_78"
...
try:
    ...
    print(f"🎨 Style: {'trunk_style': 'gnarled', 'canopy_shape': 'round', 'branch_density': 'medium', 'leaf_type': 'broad', 'seasonal_state': 'winter', 'bark_texture': 'deeply_furrowed', 'height_variation': 'normal'}")
