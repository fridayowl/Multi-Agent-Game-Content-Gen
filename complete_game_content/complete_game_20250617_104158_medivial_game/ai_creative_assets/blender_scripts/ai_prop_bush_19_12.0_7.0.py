...
# Style Parameters: {'shape': 'oval', 'density': 'thick', 'leaf_size': 'large', 'flowering': 'none', 'berry_type': 'none', 'thorns': 'heavy'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_104158_medivial_game/ai_creative_assets/ai_textures/foliage_medieval_a4be0a0e.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.4306407391561353
WIDTH_MULT = 1.061466805352996
COMPLEXITY = "complex"
DETAIL_COUNT = 2
ASYMMETRY = 0.38904250663367723
...
try:
    ...
    print(f"🎨 Style: {'shape': 'oval', 'density': 'thick', 'leaf_size': 'large', 'flowering': 'none', 'berry_type': 'none', 'thorns': 'heavy'}")
