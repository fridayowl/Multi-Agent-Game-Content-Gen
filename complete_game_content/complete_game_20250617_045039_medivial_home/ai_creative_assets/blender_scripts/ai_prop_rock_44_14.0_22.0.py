...
# Style Parameters: {'shape': 'flat', 'surface': 'mossy', 'size_category': 'medium', 'formation': 'outcrop', 'weathering': 'eroded', 'mineral_type': 'limestone'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/stone_medieval_a6f5320d.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.1598331896277077
WIDTH_MULT = 1.5743123920086246
COMPLEXITY = "complex"
DETAIL_COUNT = 2
ASYMMETRY = 0.22184429713934428
...
try:
    ...
    print(f"🎨 Style: {'shape': 'flat', 'surface': 'mossy', 'size_category': 'medium', 'formation': 'outcrop', 'weathering': 'eroded', 'mineral_type': 'limestone'}")
