...
# Style Parameters: {'construction': 'wood', 'roof_style': 'tiled', 'bucket_system': 'rope', 'water_level': 'low', 'decoration': 'carved', 'age': 'crumbling'}
...
# AI Texture paths
ai_textures = {"stone": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/stone_medieval_48be5a09.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.8949693210243367
WIDTH_MULT = 0.9297861352269675
COMPLEXITY = "medium"
DETAIL_COUNT = 2
ASYMMETRY = 0.3087881410741763
...
try:
    ...
    print(f"🎨 Style: {'construction': 'wood', 'roof_style': 'tiled', 'bucket_system': 'rope', 'water_level': 'low', 'decoration': 'carved', 'age': 'crumbling'}")
