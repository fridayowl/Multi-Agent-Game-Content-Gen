...
# Style Parameters: {'shape': 'rounded', 'surface': 'rough', 'size_category': 'small', 'formation': 'cluster', 'weathering': 'ancient', 'mineral_type': 'granite'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/stone_medieval_4785a8e1.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.7655211043231955
WIDTH_MULT = 1.0465991312911591
COMPLEXITY = "simple"
DETAIL_COUNT = 4
ASYMMETRY = 0.18631228560983856
...
try:
    ...
    print(f"🎨 Style: {'shape': 'rounded', 'surface': 'rough', 'size_category': 'small', 'formation': 'cluster', 'weathering': 'ancient', 'mineral_type': 'granite'}")
