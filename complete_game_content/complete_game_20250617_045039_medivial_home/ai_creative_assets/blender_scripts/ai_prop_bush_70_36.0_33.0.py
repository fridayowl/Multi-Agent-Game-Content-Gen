...
# Style Parameters: {'shape': 'round', 'density': 'overgrown', 'leaf_size': 'medium', 'flowering': 'none', 'berry_type': 'black', 'thorns': 'heavy'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/foliage_medieval_e921cdb3.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.2628183436793874
WIDTH_MULT = 0.9991540809928345
COMPLEXITY = "simple"
DETAIL_COUNT = 3
ASYMMETRY = 0.20702997459909026
...
try:
    ...
    print(f"🎨 Style: {'shape': 'round', 'density': 'overgrown', 'leaf_size': 'medium', 'flowering': 'none', 'berry_type': 'black', 'thorns': 'heavy'}")
