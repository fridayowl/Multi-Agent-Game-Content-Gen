...
# Style Parameters: {'shape': 'oval', 'density': 'sparse', 'leaf_size': 'large', 'flowering': 'none', 'berry_type': 'purple', 'thorns': 'heavy'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/foliage_medieval_22fdf48c.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.9891292483004472
WIDTH_MULT = 0.8097955937893251
COMPLEXITY = "complex"
DETAIL_COUNT = 4
ASYMMETRY = 0.3101807589440876
...
try:
    ...
    print(f"🎨 Style: {'shape': 'oval', 'density': 'sparse', 'leaf_size': 'large', 'flowering': 'none', 'berry_type': 'purple', 'thorns': 'heavy'}")
