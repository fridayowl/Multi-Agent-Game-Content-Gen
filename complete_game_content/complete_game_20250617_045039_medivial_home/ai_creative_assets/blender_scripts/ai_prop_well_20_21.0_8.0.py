...
# Style Parameters: {'construction': 'metal', 'roof_style': 'wooden', 'bucket_system': 'chain', 'water_level': 'low', 'decoration': 'plain', 'age': 'ancient'}
...
# AI Texture paths
ai_textures = {"stone": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/stone_medieval_b7621497.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.4800602677315025
WIDTH_MULT = 1.0057742040069657
COMPLEXITY = "complex"
DETAIL_COUNT = 5
ASYMMETRY = 0.24638481113074112
...
try:
    ...
    print(f"🎨 Style: {'construction': 'metal', 'roof_style': 'wooden', 'bucket_system': 'chain', 'water_level': 'low', 'decoration': 'plain', 'age': 'ancient'}")
