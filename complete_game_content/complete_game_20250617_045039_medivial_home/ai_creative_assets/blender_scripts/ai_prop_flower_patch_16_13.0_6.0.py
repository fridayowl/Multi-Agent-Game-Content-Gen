...
# Style Parameters: {'shape': 'round', 'size': 'small', 'texture': 'weathered', 'color_scheme': 'muted', 'complexity': 'moderate'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/generic_medieval_57a6dc57.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.3031532556187708
WIDTH_MULT = 0.9038351606165386
COMPLEXITY = "medium"
DETAIL_COUNT = 5
ASYMMETRY = 0.29195229073542717
...
try:
    ...
    print(f"🎨 Style: {'shape': 'round', 'size': 'small', 'texture': 'weathered', 'color_scheme': 'muted', 'complexity': 'moderate'}")
