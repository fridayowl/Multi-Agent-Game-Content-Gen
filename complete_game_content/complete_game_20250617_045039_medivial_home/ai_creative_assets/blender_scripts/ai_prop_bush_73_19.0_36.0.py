...
# Style Parameters: {'shape': 'oval', 'density': 'overgrown', 'leaf_size': 'small', 'flowering': 'summer', 'berry_type': 'purple', 'thorns': 'heavy'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/foliage_medieval_c6f42c97.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.4591519990121087
WIDTH_MULT = 0.9788179736575616
COMPLEXITY = "medium"
DETAIL_COUNT = 6
ASYMMETRY = 0.1017661669078382
...
try:
    ...
    print(f"🎨 Style: {'shape': 'oval', 'density': 'overgrown', 'leaf_size': 'small', 'flowering': 'summer', 'berry_type': 'purple', 'thorns': 'heavy'}")
