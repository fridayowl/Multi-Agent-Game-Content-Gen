...
# Style Parameters: {'shape': 'upright', 'density': 'sparse', 'leaf_size': 'small', 'flowering': 'year_round', 'berry_type': 'black', 'thorns': 'light'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/foliage_medieval_1200b71f.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.1722269684060311
WIDTH_MULT = 1.2671885825454268
COMPLEXITY = "complex"
DETAIL_COUNT = 6
ASYMMETRY = 0.36919795321317095
...
def create_ai_rock():
    ...
    rock.name = f"AI_upright_rock_78"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_upright_bush_78"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'upright', 'density': 'sparse', 'leaf_size': 'small', 'flowering': 'year_round', 'berry_type': 'black', 'thorns': 'light'}")
