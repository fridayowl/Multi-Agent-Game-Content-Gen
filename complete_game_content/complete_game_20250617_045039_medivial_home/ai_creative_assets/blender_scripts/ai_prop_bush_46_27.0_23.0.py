...
# Style Parameters: {'shape': 'spreading', 'density': 'overgrown', 'leaf_size': 'large', 'flowering': 'spring', 'berry_type': 'purple', 'thorns': 'heavy'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/foliage_medieval_d32985c3.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.231286207124371
WIDTH_MULT = 1.2012672392443569
COMPLEXITY = "complex"
DETAIL_COUNT = 3
ASYMMETRY = 0.1496776721556931
...
def create_ai_rock():
    ...
    rock.name = f"AI_spreading_rock_46"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_spreading_bush_46"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'spreading', 'density': 'overgrown', 'leaf_size': 'large', 'flowering': 'spring', 'berry_type': 'purple', 'thorns': 'heavy'}")
