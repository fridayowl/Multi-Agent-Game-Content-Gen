...
# Style Parameters: {'shape': 'upright', 'density': 'medium', 'leaf_size': 'small', 'flowering': 'spring', 'berry_type': 'none', 'thorns': 'none'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/foliage_medieval_a4be0a0e.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.221439376784473
WIDTH_MULT = 1.1745009736568863
COMPLEXITY = "medium"
DETAIL_COUNT = 3
ASYMMETRY = 0.1353556803520345
...
def create_ai_rock():
    ...
    rock.name = f"AI_upright_rock_19"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_upright_bush_19"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'upright', 'density': 'medium', 'leaf_size': 'small', 'flowering': 'spring', 'berry_type': 'none', 'thorns': 'none'}")
