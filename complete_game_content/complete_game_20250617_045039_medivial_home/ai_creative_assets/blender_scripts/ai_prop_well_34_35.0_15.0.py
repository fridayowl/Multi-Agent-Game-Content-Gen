...
# Style Parameters: {'construction': 'brick', 'roof_style': 'none', 'bucket_system': 'chain', 'water_level': 'medium', 'decoration': 'plain', 'age': 'ancient'}
...
# AI Texture paths
ai_textures = {"stone": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/stone_medieval_00b52781.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.295536273561915
WIDTH_MULT = 1.2031120092657968
COMPLEXITY = "simple"
DETAIL_COUNT = 5
ASYMMETRY = 0.13067798103844164
...
try:
    ...
    print(f"🎨 Style: {'construction': 'brick', 'roof_style': 'none', 'bucket_system': 'chain', 'water_level': 'medium', 'decoration': 'plain', 'age': 'ancient'}")
