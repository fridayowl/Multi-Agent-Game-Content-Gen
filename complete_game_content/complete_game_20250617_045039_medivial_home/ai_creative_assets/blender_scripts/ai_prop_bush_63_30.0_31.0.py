...
# Style Parameters: {'shape': 'spreading', 'density': 'sparse', 'leaf_size': 'medium', 'flowering': 'spring', 'berry_type': 'red', 'thorns': 'heavy'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/foliage_medieval_76e143b5.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.3039260980703844
WIDTH_MULT = 0.9076299751968064
COMPLEXITY = "medium"
DETAIL_COUNT = 2
ASYMMETRY = 0.24701916193371232
...
def create_ai_rock():
    ...
    rock.name = f"AI_spreading_rock_63"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_spreading_bush_63"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'spreading', 'density': 'sparse', 'leaf_size': 'medium', 'flowering': 'spring', 'berry_type': 'red', 'thorns': 'heavy'}")
