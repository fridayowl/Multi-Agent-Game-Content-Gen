...
# Style Parameters: {'shape': 'flat', 'surface': 'rough', 'size_category': 'medium', 'formation': 'cluster', 'weathering': 'weathered', 'mineral_type': 'sandstone'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/stone_medieval_a8c16632.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.8772727357328577
WIDTH_MULT = 1.5647348079995034
COMPLEXITY = "medium"
DETAIL_COUNT = 4
ASYMMETRY = 0.2269793567810645
...
try:
    ...
    print(f"🎨 Style: {'shape': 'flat', 'surface': 'rough', 'size_category': 'medium', 'formation': 'cluster', 'weathering': 'weathered', 'mineral_type': 'sandstone'}")
