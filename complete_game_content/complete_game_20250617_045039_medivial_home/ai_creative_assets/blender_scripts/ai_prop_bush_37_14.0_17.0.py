...
# Style Parameters: {'shape': 'upright', 'density': 'overgrown', 'leaf_size': 'large', 'flowering': 'spring', 'berry_type': 'none', 'thorns': 'heavy'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/foliage_medieval_b392554e.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.8846773944465995
WIDTH_MULT = 1.1444591510676787
COMPLEXITY = "simple"
DETAIL_COUNT = 2
ASYMMETRY = 0.31626014242760225
...
def create_ai_rock():
    ...
    rock.name = f"AI_upright_rock_37"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_upright_bush_37"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'upright', 'density': 'overgrown', 'leaf_size': 'large', 'flowering': 'spring', 'berry_type': 'none', 'thorns': 'heavy'}")
