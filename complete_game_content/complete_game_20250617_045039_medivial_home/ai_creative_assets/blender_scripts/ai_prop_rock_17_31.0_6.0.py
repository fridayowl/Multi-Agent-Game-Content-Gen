...
# Style Parameters: {'shape': 'rounded', 'surface': 'mossy', 'size_category': 'boulder', 'formation': 'pile', 'weathering': 'weathered', 'mineral_type': 'limestone'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/stone_medieval_6e2d275c.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.0206041326264965
WIDTH_MULT = 1.5324856673241036
COMPLEXITY = "simple"
DETAIL_COUNT = 4
ASYMMETRY = 0.36865874937748166
...
try:
    ...
    print(f"🎨 Style: {'shape': 'rounded', 'surface': 'mossy', 'size_category': 'boulder', 'formation': 'pile', 'weathering': 'weathered', 'mineral_type': 'limestone'}")
