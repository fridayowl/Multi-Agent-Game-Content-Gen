...
# Style Parameters: {'shape': 'crystalline', 'surface': 'mossy', 'size_category': 'small', 'formation': 'cluster', 'weathering': 'weathered', 'mineral_type': 'sandstone'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/stone_medieval_7d19ddac.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.9065933317582139
WIDTH_MULT = 1.0890134040873654
COMPLEXITY = "medium"
DETAIL_COUNT = 2
ASYMMETRY = 0.19060388808579382
...
def create_ai_rock():
    ...
    rock.name = f"AI_crystalline_rock_28"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_crystalline_bush_28"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'crystalline', 'surface': 'mossy', 'size_category': 'small', 'formation': 'cluster', 'weathering': 'weathered', 'mineral_type': 'sandstone'}")
