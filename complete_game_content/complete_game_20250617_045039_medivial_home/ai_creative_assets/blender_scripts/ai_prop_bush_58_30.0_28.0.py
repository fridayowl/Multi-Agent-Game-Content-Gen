...
# Style Parameters: {'shape': 'spreading', 'density': 'medium', 'leaf_size': 'medium', 'flowering': 'spring', 'berry_type': 'black', 'thorns': 'heavy'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/foliage_medieval_98528506.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.8334253304205608
WIDTH_MULT = 1.158151369780158
COMPLEXITY = "complex"
DETAIL_COUNT = 6
ASYMMETRY = 0.3665337350546234
...
def create_ai_rock():
    ...
    rock.name = f"AI_spreading_rock_58"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_spreading_bush_58"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'spreading', 'density': 'medium', 'leaf_size': 'medium', 'flowering': 'spring', 'berry_type': 'black', 'thorns': 'heavy'}")
