...
# Style Parameters: {'shape': 'oval', 'density': 'overgrown', 'leaf_size': 'medium', 'flowering': 'spring', 'berry_type': 'black', 'thorns': 'light'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/foliage_medieval_a0e5a3b2.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.4645870482933074
WIDTH_MULT = 1.2387094504771206
COMPLEXITY = "medium"
DETAIL_COUNT = 2
ASYMMETRY = 0.2582508275479879
...
try:
    ...
    print(f"🎨 Style: {'shape': 'oval', 'density': 'overgrown', 'leaf_size': 'medium', 'flowering': 'spring', 'berry_type': 'black', 'thorns': 'light'}")
