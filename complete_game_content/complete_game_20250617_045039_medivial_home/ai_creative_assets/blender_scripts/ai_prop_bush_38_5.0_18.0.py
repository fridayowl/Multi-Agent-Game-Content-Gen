...
# Style Parameters: {'shape': 'round', 'density': 'thick', 'leaf_size': 'large', 'flowering': 'spring', 'berry_type': 'blue', 'thorns': 'none'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/foliage_medieval_8fbc2bb8.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.0021764530427884
WIDTH_MULT = 1.2597161707732352
COMPLEXITY = "complex"
DETAIL_COUNT = 6
ASYMMETRY = 0.1703314740645998
...
try:
    ...
    print(f"🎨 Style: {'shape': 'round', 'density': 'thick', 'leaf_size': 'large', 'flowering': 'spring', 'berry_type': 'blue', 'thorns': 'none'}")
