...
# Style Parameters: {'shape': 'round', 'density': 'sparse', 'leaf_size': 'large', 'flowering': 'summer', 'berry_type': 'none', 'thorns': 'light'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/foliage_medieval_b4c89502.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.8892249559929739
WIDTH_MULT = 1.2122627108560895
COMPLEXITY = "complex"
DETAIL_COUNT = 4
ASYMMETRY = 0.12484039838823298
...
try:
    ...
    print(f"🎨 Style: {'shape': 'round', 'density': 'sparse', 'leaf_size': 'large', 'flowering': 'summer', 'berry_type': 'none', 'thorns': 'light'}")
