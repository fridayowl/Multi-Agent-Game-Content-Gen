...
# Style Parameters: {'shape': 'upright', 'density': 'medium', 'leaf_size': 'small', 'flowering': 'year_round', 'berry_type': 'purple', 'thorns': 'heavy'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/foliage_medieval_5782ab46.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.1990704411891637
WIDTH_MULT = 0.8183517705600034
COMPLEXITY = "simple"
DETAIL_COUNT = 5
ASYMMETRY = 0.327207207301803
...
def create_ai_rock():
    ...
    rock.name = f"AI_upright_rock_64"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_upright_bush_64"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'upright', 'density': 'medium', 'leaf_size': 'small', 'flowering': 'year_round', 'berry_type': 'purple', 'thorns': 'heavy'}")
