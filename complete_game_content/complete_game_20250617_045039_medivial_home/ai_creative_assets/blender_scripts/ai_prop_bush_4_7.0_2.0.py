...
# Style Parameters: {'shape': 'spreading', 'density': 'thick', 'leaf_size': 'medium', 'flowering': 'summer', 'berry_type': 'red', 'thorns': 'heavy'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/foliage_medieval_809dede7.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.3246227838916234
WIDTH_MULT = 1.2263323933806527
COMPLEXITY = "medium"
DETAIL_COUNT = 4
ASYMMETRY = 0.2120784098788329
...
def create_ai_rock():
    ...
    rock.name = f"AI_spreading_rock_4"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_spreading_bush_4"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'spreading', 'density': 'thick', 'leaf_size': 'medium', 'flowering': 'summer', 'berry_type': 'red', 'thorns': 'heavy'}")
