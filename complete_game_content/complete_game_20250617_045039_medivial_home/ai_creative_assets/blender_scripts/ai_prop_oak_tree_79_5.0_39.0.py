...
# Style Parameters: {'trunk_style': 'gnarled', 'canopy_shape': 'oval', 'branch_density': 'dense', 'leaf_type': 'broad', 'seasonal_state': 'autumn', 'bark_texture': 'rough', 'height_variation': 'normal'}
...
# AI Texture paths
ai_textures = {"bark": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/wood_medieval_08e3093c.png", "leaves": "complete_game_content/complete_game_20250617_045039_medivial_home/ai_creative_assets/ai_textures/foliage_medieval_b86ba4ca.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 2.372931439302149
WIDTH_MULT = 1.0023649233421774
COMPLEXITY = "medium"
DETAIL_COUNT = 3
ASYMMETRY = 0.1944970738620073
...
def create_ai_unique_oak_tree():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_oak_tree_79"
...
try:
    ...
    print(f"🎨 Style: {'trunk_style': 'gnarled', 'canopy_shape': 'oval', 'branch_density': 'dense', 'leaf_type': 'broad', 'seasonal_state': 'autumn', 'bark_texture': 'rough', 'height_variation': 'normal'}")
