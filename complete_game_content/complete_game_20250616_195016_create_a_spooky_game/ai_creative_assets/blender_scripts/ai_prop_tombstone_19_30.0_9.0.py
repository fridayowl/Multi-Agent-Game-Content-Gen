...
# Style Parameters: {'shape': 'geometric', 'size': 'medium', 'texture': 'weathered', 'color_scheme': 'vibrant', 'complexity': 'complex'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250616_195016_create_a_spooky_game/ai_creative_assets/ai_textures/generic_spooky_c1d9577e.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.0977011231378309
WIDTH_MULT = 1.112898473380505
COMPLEXITY = "medium"
DETAIL_COUNT = 6
ASYMMETRY = 0.2504059966740739
...
def create_ai_unique_tombstone():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_tombstone_19"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'geometric', 'size': 'medium', 'texture': 'weathered', 'color_scheme': 'vibrant', 'complexity': 'complex'}")
