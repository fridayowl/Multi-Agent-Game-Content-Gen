...
# Style Parameters: {'shape': 'geometric', 'size': 'small', 'texture': 'smooth', 'color_scheme': 'natural', 'complexity': 'intricate'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_113549_Generate_a_desert_oasis_tradin/ai_creative_assets/ai_textures/generic_desert_4f91dc71.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.3294036029992276
WIDTH_MULT = 1.1650220767672108
COMPLEXITY = "simple"
DETAIL_COUNT = 3
ASYMMETRY = 0.24020988097153237
...
def create_ai_unique_sand_dune():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_sand_dune_5"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'geometric', 'size': 'small', 'texture': 'smooth', 'color_scheme': 'natural', 'complexity': 'intricate'}")
