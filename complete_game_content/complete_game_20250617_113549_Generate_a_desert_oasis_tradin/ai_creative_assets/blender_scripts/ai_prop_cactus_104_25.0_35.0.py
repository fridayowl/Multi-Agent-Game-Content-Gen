...
# Style Parameters: {'shape': 'angular', 'size': 'small', 'texture': 'rough', 'color_scheme': 'muted', 'complexity': 'complex'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_113549_Generate_a_desert_oasis_tradin/ai_creative_assets/ai_textures/generic_desert_87f860af.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.8128774714361658
WIDTH_MULT = 0.950400681978089
COMPLEXITY = "simple"
DETAIL_COUNT = 5
ASYMMETRY = 0.2646860095631265
...
def create_ai_unique_cactus():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_cactus_104"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'angular', 'size': 'small', 'texture': 'rough', 'color_scheme': 'muted', 'complexity': 'complex'}")
