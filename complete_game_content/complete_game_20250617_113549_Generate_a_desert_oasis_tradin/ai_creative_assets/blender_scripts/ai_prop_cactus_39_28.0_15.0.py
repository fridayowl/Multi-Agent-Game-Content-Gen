...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_113549_Generate_a_desert_oasis_tradin/ai_creative_assets/ai_textures/generic_desert_226532fe.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.104870244563913
WIDTH_MULT = 1.1142786135801013
COMPLEXITY = "complex"
DETAIL_COUNT = 5
ASYMMETRY = 0.2955290829835846
...
def create_ai_unique_cactus():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_cactus_39"
