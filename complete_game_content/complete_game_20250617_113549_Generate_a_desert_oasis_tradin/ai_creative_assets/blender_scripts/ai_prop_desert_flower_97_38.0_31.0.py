...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_113549_Generate_a_desert_oasis_tradin/ai_creative_assets/ai_textures/generic_desert_06b85de8.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.4875096071469076
WIDTH_MULT = 0.8824770996765335
COMPLEXITY = "simple"
DETAIL_COUNT = 3
ASYMMETRY = 0.3917442677138505
...
def create_ai_unique_desert_flower():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_desert_flower_97"
...
def create_ai_tree():
    ...
    if trunk_style == "twisted":
        ...
        for i in range(max(2, DETAIL_COUNT // 2)):
            ...
            segment.name = f"AI_twisted_segment_{i}_97"
        ...
        trunk.name = f"AI_gnarled_trunk_97"
        ...
        for i in range(2):
            ...
            branch.name = f"AI_split_branch_{i}_97"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_straight_trunk_97"
        tree_parts.append(trunk)
    ...
    if canopy_shape == "round":
        ...
        canopy.name = f"AI_round_canopy_97"
        ...
        canopy.name = f"AI_oval_canopy_97"
        tree_parts.append(canopy)
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere.name = f"AI_irregular_canopy_{i}_97"
        ...
        for i in range(cluster_count):
            ...
            cluster.name = f"AI_sparse_cluster_{i}_97"
        ...
        for i in range(frond_count):
            ...
            frond.name = f"AI_palm_frond_{i}_97"
        ...
        canopy = bpy.context.active_object
        canopy.name = f"AI_default_canopy_97"
        tree_parts.append(canopy)
...
def create_ai_rock():
    ...
    if rock_shape == "angular":
        ...
        for i in range(DETAIL_COUNT // 2):
            ...
            crystal.name = f"AI_crystal_{i}_97"
    ...
    rock.name = f"AI_organic_rock_97"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere = bpy.context.active_object
            sphere.name = f"AI_spreading_bush_{i}_97"
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_organic_bush_97"
...
def create_ai_generic_prop():
    ...
    prop.name = f"AI_generic_prop_97"
