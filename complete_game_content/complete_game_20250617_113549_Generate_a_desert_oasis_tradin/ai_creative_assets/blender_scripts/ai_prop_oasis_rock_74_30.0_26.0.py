...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_113549_Generate_a_desert_oasis_tradin/ai_creative_assets/ai_textures/generic_desert_2cdb8240.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.450939541870271
WIDTH_MULT = 1.183533251662895
COMPLEXITY = "medium"
DETAIL_COUNT = 5
ASYMMETRY = 0.30573462048707933
...
def create_ai_unique_oasis_rock():
    ...
    if len(prop_objects) > 1:
        ...
        if prop_objects:
            ...
            final_prop.name = f"AI_oasis_rock_74"
...
def create_ai_tree():
    ...
    if trunk_style == "twisted":
        ...
        for i in range(max(2, DETAIL_COUNT // 2)):
            ...
            segment.name = f"AI_twisted_segment_{i}_74"
        ...
        trunk.name = f"AI_gnarled_trunk_74"
        ...
        for i in range(2):
            ...
            branch.name = f"AI_split_branch_{i}_74"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_straight_trunk_74"
        tree_parts.append(trunk)
    ...
    if canopy_shape == "round":
        ...
        canopy.name = f"AI_round_canopy_74"
        ...
        canopy.name = f"AI_oval_canopy_74"
        tree_parts.append(canopy)
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere.name = f"AI_irregular_canopy_{i}_74"
        ...
        for i in range(cluster_count):
            ...
            cluster.name = f"AI_sparse_cluster_{i}_74"
        ...
        for i in range(frond_count):
            ...
            frond.name = f"AI_palm_frond_{i}_74"
        ...
        canopy = bpy.context.active_object
        canopy.name = f"AI_default_canopy_74"
        tree_parts.append(canopy)
...
def create_ai_rock():
    ...
    if rock_shape == "angular":
        ...
        for i in range(DETAIL_COUNT // 2):
            ...
            crystal.name = f"AI_crystal_{i}_74"
    ...
    rock.name = f"AI_organic_rock_74"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere = bpy.context.active_object
            sphere.name = f"AI_spreading_bush_{i}_74"
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_organic_bush_74"
...
def create_ai_generic_prop():
    ...
    prop.name = f"AI_generic_prop_74"
