...
# Style Parameters: {'construction': 'stone', 'roof_style': 'none', 'bucket_system': 'chain', 'water_level': 'high', 'decoration': 'painted', 'age': 'crumbling'}
...
# AI Texture paths
ai_textures = {"stone": "complete_game_content/complete_game_20250615_130428_medivial_game/ai_creative_assets/ai_textures/stone_medieval_4fb23ffe.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.263045048039012
WIDTH_MULT = 1.2118254483667352
COMPLEXITY = "medium"
DETAIL_COUNT = 3
ASYMMETRY = 0.3895539044946713
...
def create_ai_rock():
    ...
    rock.name = f"AI_rounded_rock_32"
...
try:
    ...
    print(f"🎨 Style: {'construction': 'stone', 'roof_style': 'none', 'bucket_system': 'chain', 'water_level': 'high', 'decoration': 'painted', 'age': 'crumbling'}")
