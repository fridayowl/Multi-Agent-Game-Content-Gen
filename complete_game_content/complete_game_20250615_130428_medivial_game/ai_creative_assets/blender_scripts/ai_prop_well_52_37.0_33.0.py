...
# Style Parameters: {'construction': 'metal', 'roof_style': 'none', 'bucket_system': 'pulley', 'water_level': 'low', 'decoration': 'plain', 'age': 'crumbling'}
...
# AI Texture paths
ai_textures = {"stone": "complete_game_content/complete_game_20250615_130428_medivial_game/ai_creative_assets/ai_textures/stone_medieval_fbed31c5.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.3031597026924615
WIDTH_MULT = 0.8106425658300981
COMPLEXITY = "complex"
DETAIL_COUNT = 4
ASYMMETRY = 0.25420768834712226
...
try:
    ...
    print(f"🎨 Style: {'construction': 'metal', 'roof_style': 'none', 'bucket_system': 'pulley', 'water_level': 'low', 'decoration': 'plain', 'age': 'crumbling'}")
