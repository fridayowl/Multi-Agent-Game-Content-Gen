...
# Style Parameters: {'shape': 'angular', 'surface': 'rough', 'size_category': 'boulder', 'formation': 'cluster', 'weathering': 'eroded', 'mineral_type': 'sandstone'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250615_130428_medivial_game/ai_creative_assets/ai_textures/stone_medieval_392c1ef6.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.1906985735946294
WIDTH_MULT = 0.8003990426966672
COMPLEXITY = "simple"
DETAIL_COUNT = 3
ASYMMETRY = 0.19798047920026648
...
try:
    ...
    print(f"🎨 Style: {'shape': 'angular', 'surface': 'rough', 'size_category': 'boulder', 'formation': 'cluster', 'weathering': 'eroded', 'mineral_type': 'sandstone'}")
