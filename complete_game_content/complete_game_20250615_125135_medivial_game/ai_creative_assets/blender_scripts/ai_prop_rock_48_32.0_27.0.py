...
# Style Parameters: {'shape': 'flat', 'surface': 'rough', 'size_category': 'boulder', 'formation': 'cluster', 'weathering': 'ancient', 'mineral_type': 'sandstone'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250615_125135_medivial_game/ai_creative_assets/ai_textures/stone_medieval_469f92ba.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.6351282163155714
WIDTH_MULT = 1.2111814413003603
COMPLEXITY = "simple"
DETAIL_COUNT = 6
ASYMMETRY = 0.2821656860750261
...
try:
    ...
    print(f"🎨 Style: {'shape': 'flat', 'surface': 'rough', 'size_category': 'boulder', 'formation': 'cluster', 'weathering': 'ancient', 'mineral_type': 'sandstone'}")
