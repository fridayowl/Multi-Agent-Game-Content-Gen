...
# Style Parameters: {'shape': 'round', 'density': 'medium', 'leaf_size': 'medium', 'flowering': 'summer', 'berry_type': 'red', 'thorns': 'light'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250616_001942_medieval_game/ai_creative_assets/ai_textures/foliage_medieval_680e1d52.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.431736966598155
WIDTH_MULT = 1.1183721359471237
COMPLEXITY = "complex"
DETAIL_COUNT = 4
ASYMMETRY = 0.33804655361796637
...
try:
    ...
    print(f"🎨 Style: {'shape': 'round', 'density': 'medium', 'leaf_size': 'medium', 'flowering': 'summer', 'berry_type': 'red', 'thorns': 'light'}")
