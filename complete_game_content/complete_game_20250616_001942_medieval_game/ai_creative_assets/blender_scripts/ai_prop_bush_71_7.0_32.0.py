...
# Style Parameters: {'shape': 'round', 'density': 'sparse', 'leaf_size': 'large', 'flowering': 'none', 'berry_type': 'red', 'thorns': 'none'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250616_001942_medieval_game/ai_creative_assets/ai_textures/foliage_medieval_a2cd9e8c.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.1543774011995958
WIDTH_MULT = 0.966120662550501
COMPLEXITY = "medium"
DETAIL_COUNT = 2
ASYMMETRY = 0.17388059055306962
...
try:
    ...
    print(f"🎨 Style: {'shape': 'round', 'density': 'sparse', 'leaf_size': 'large', 'flowering': 'none', 'berry_type': 'red', 'thorns': 'none'}")
