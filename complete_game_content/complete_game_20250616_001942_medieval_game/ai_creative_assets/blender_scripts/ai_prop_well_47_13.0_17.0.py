...
# Style Parameters: {'construction': 'metal', 'roof_style': 'none', 'bucket_system': 'rope', 'water_level': 'medium', 'decoration': 'plain', 'age': 'weathered'}
...
# AI Texture paths
ai_textures = {"stone": "complete_game_content/complete_game_20250616_001942_medieval_game/ai_creative_assets/ai_textures/stone_medieval_f3b025ca.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.0784961952102523
WIDTH_MULT = 1.0967029916084359
COMPLEXITY = "medium"
DETAIL_COUNT = 6
ASYMMETRY = 0.3369378911058943
...
try:
    ...
    print(f"🎨 Style: {'construction': 'metal', 'roof_style': 'none', 'bucket_system': 'rope', 'water_level': 'medium', 'decoration': 'plain', 'age': 'weathered'}")
