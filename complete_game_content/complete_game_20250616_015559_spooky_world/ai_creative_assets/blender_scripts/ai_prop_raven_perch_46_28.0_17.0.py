...
# Style Parameters: {'shape': 'organic', 'size': 'small', 'texture': 'weathered', 'color_scheme': 'muted', 'complexity': 'simple'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250616_015559_spooky_world/ai_creative_assets/ai_textures/generic_spooky_bf4573d7.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.4602320383494363
WIDTH_MULT = 1.099463288703274
COMPLEXITY = "medium"
DETAIL_COUNT = 5
ASYMMETRY = 0.1771791230827341
...
try:
    ...
    print(f"🎨 Style: {'shape': 'organic', 'size': 'small', 'texture': 'weathered', 'color_scheme': 'muted', 'complexity': 'simple'}")
