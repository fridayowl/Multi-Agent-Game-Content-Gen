...
# Style Parameters: {'shape': 'crystalline', 'surface': 'smooth', 'size_category': 'small', 'formation': 'outcrop', 'weathering': 'eroded', 'mineral_type': 'limestone'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250615_133431_medieval_fantasy_setting/ai_creative_assets/ai_textures/stone_medieval_ead82d9d.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.5049927436318105
WIDTH_MULT = 1.3615003115918525
COMPLEXITY = "complex"
DETAIL_COUNT = 4
ASYMMETRY = 0.25767075758910807
...
def create_ai_tree():
    ...
    if trunk_style == "twisted":
        ...
        for i in range(max(2, DETAIL_COUNT // 2)):
            ...
            segment.name = f"AI_twisted_segment_{i}_70"
        ...
        trunk.name = f"AI_gnarled_trunk_70"
        ...
        for i in range(2):
            ...
            branch.name = f"AI_split_branch_{i}_70"
        ...
        trunk = bpy.context.active_object
        trunk.name = f"AI_straight_trunk_70"
        tree_parts.append(trunk)
    ...
    if canopy_shape == "round":
        ...
        canopy.name = f"AI_round_canopy_70"
        ...
        canopy.name = f"AI_oval_canopy_70"
        tree_parts.append(canopy)
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere.name = f"AI_irregular_canopy_{i}_70"
        ...
        for i in range(cluster_count):
            ...
            cluster.name = f"AI_sparse_cluster_{i}_70"
        ...
        for i in range(frond_count):
            ...
            frond.name = f"AI_palm_frond_{i}_70"
        ...
        canopy = bpy.context.active_object
        canopy.name = f"AI_default_canopy_70"
        tree_parts.append(canopy)
...
def create_ai_rock():
    ...
    if rock_shape == "angular":
        ...
        for i in range(DETAIL_COUNT // 2):
            ...
            crystal.name = f"AI_crystal_{i}_70"
    ...
    rock.name = f"AI_crystalline_rock_70"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        for i in range(DETAIL_COUNT):
            ...
            sphere = bpy.context.active_object
            sphere.name = f"AI_spreading_bush_{i}_70"
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_crystalline_bush_70"
...
def create_ai_generic_prop():
    ...
    prop.name = f"AI_generic_prop_70"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'crystalline', 'surface': 'smooth', 'size_category': 'small', 'formation': 'outcrop', 'weathering': 'eroded', 'mineral_type': 'limestone'}")
