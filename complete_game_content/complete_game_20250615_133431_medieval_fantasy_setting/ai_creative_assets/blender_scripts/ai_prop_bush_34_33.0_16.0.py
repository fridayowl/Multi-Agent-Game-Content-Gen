...
# Prop #35: bush
# AI Description: A unique medieval bush with distinctive characteristics
# Style Parameters: {'shape': 'spreading', 'density': 'overgrown', 'leaf_size': 'small', 'flowering': 'summer', 'berry_type': 'black', 'thorns': 'heavy'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250615_133431_medieval_fantasy_setting/ai_creative_assets/ai_textures/foliage_medieval_263f5490.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.2042871145902219
WIDTH_MULT = 0.9735924880961297
COMPLEXITY = "simple"
DETAIL_COUNT = 2
ASYMMETRY = 0.29640109268620907
...
def create_ai_rock():
    ...
    rock.name = f"AI_spreading_rock_34"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_spreading_bush_34"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'spreading', 'density': 'overgrown', 'leaf_size': 'small', 'flowering': 'summer', 'berry_type': 'black', 'thorns': 'heavy'}")
