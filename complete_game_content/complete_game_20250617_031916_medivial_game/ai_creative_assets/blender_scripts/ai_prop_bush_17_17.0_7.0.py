...
# Style Parameters: {'shape': 'oval', 'density': 'thick', 'leaf_size': 'small', 'flowering': 'none', 'berry_type': 'none', 'thorns': 'none'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_031916_medivial_game/ai_creative_assets/ai_textures/foliage_medieval_db1bc76d.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.050327013431375
WIDTH_MULT = 0.851920770515989
COMPLEXITY = "medium"
DETAIL_COUNT = 4
ASYMMETRY = 0.36746186412523796
...
try:
    ...
    print(f"🎨 Style: {'shape': 'oval', 'density': 'thick', 'leaf_size': 'small', 'flowering': 'none', 'berry_type': 'none', 'thorns': 'none'}")
