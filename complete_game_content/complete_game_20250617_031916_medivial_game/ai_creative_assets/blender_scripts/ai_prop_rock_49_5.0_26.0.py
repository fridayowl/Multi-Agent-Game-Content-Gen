...
# Style Parameters: {'shape': 'rounded', 'surface': 'cracked', 'size_category': 'medium', 'formation': 'single', 'weathering': 'fresh', 'mineral_type': 'limestone'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_031916_medivial_game/ai_creative_assets/ai_textures/stone_medieval_a3692af3.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.5102941053264662
WIDTH_MULT = 1.5221389044552225
COMPLEXITY = "complex"
DETAIL_COUNT = 6
ASYMMETRY = 0.20514934013521663
...
try:
    ...
    print(f"🎨 Style: {'shape': 'rounded', 'surface': 'cracked', 'size_category': 'medium', 'formation': 'single', 'weathering': 'fresh', 'mineral_type': 'limestone'}")
