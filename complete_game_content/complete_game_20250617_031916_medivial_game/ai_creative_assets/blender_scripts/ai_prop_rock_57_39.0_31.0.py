...
# Style Parameters: {'shape': 'flat', 'surface': 'mossy', 'size_category': 'boulder', 'formation': 'single', 'weathering': 'weathered', 'mineral_type': 'granite'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_031916_medivial_game/ai_creative_assets/ai_textures/stone_medieval_abc64dd1.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.687382624686677
WIDTH_MULT = 1.4532245792090814
COMPLEXITY = "simple"
DETAIL_COUNT = 5
ASYMMETRY = 0.3905756577078875
...
try:
    ...
    print(f"🎨 Style: {'shape': 'flat', 'surface': 'mossy', 'size_category': 'boulder', 'formation': 'single', 'weathering': 'weathered', 'mineral_type': 'granite'}")
