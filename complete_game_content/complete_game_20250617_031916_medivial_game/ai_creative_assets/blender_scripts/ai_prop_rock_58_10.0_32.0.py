...
# Style Parameters: {'shape': 'angular', 'surface': 'smooth', 'size_category': 'medium', 'formation': 'single', 'weathering': 'ancient', 'mineral_type': 'limestone'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_031916_medivial_game/ai_creative_assets/ai_textures/stone_medieval_327b0770.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.033361978618627
WIDTH_MULT = 0.8982011314706281
COMPLEXITY = "complex"
DETAIL_COUNT = 6
ASYMMETRY = 0.11561589140165437
...
try:
    ...
    print(f"🎨 Style: {'shape': 'angular', 'surface': 'smooth', 'size_category': 'medium', 'formation': 'single', 'weathering': 'ancient', 'mineral_type': 'limestone'}")
