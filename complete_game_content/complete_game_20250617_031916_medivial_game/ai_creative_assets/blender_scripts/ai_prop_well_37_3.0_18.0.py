...
# Style Parameters: {'construction': 'brick', 'roof_style': 'thatched', 'bucket_system': 'crank', 'water_level': 'low', 'decoration': 'carved', 'age': 'new'}
...
# AI Texture paths
ai_textures = {"stone": "complete_game_content/complete_game_20250617_031916_medivial_game/ai_creative_assets/ai_textures/stone_medieval_13dc8db7.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.8219036807787232
WIDTH_MULT = 0.8822273674492982
COMPLEXITY = "complex"
DETAIL_COUNT = 4
ASYMMETRY = 0.1327395798980018
...
try:
    ...
    print(f"🎨 Style: {'construction': 'brick', 'roof_style': 'thatched', 'bucket_system': 'crank', 'water_level': 'low', 'decoration': 'carved', 'age': 'new'}")
