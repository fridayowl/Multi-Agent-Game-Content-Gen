...
# Style Parameters: {'shape': 'rounded', 'surface': 'cracked', 'size_category': 'medium', 'formation': 'single', 'weathering': 'fresh', 'mineral_type': 'granite'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_031916_medivial_game/ai_creative_assets/ai_textures/stone_medieval_cc08d10c.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.9355485350631136
WIDTH_MULT = 0.8482623594495985
COMPLEXITY = "medium"
DETAIL_COUNT = 5
ASYMMETRY = 0.24014617331695773
...
def create_ai_rock():
    ...
    rock.name = f"AI_rounded_rock_34"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_rounded_bush_34"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'rounded', 'surface': 'cracked', 'size_category': 'medium', 'formation': 'single', 'weathering': 'fresh', 'mineral_type': 'granite'}")
