...
# Style Parameters: {'construction': 'metal', 'roof_style': 'wooden', 'bucket_system': 'rope', 'water_level': 'low', 'decoration': 'plain', 'age': 'weathered'}
...
# AI Texture paths
ai_textures = {"stone": "complete_game_content/complete_game_20250617_031916_medivial_game/ai_creative_assets/ai_textures/stone_medieval_d0976445.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.0394246309621096
WIDTH_MULT = 0.9996998096726304
COMPLEXITY = "complex"
DETAIL_COUNT = 4
ASYMMETRY = 0.38431671819433244
...
def create_ai_rock():
    ...
    rock.name = f"AI_rounded_rock_63"
...
try:
    ...
    print(f"🎨 Style: {'construction': 'metal', 'roof_style': 'wooden', 'bucket_system': 'rope', 'water_level': 'low', 'decoration': 'plain', 'age': 'weathered'}")
