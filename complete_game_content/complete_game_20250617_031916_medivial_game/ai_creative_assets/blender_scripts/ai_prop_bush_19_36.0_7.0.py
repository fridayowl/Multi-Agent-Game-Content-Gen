...
# Style Parameters: {'shape': 'oval', 'density': 'medium', 'leaf_size': 'small', 'flowering': 'year_round', 'berry_type': 'purple', 'thorns': 'none'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_031916_medivial_game/ai_creative_assets/ai_textures/foliage_medieval_a4be0a0e.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.019664041548145
WIDTH_MULT = 1.1959326209084502
COMPLEXITY = "medium"
DETAIL_COUNT = 3
ASYMMETRY = 0.3854595195056014
...
try:
    ...
    print(f"🎨 Style: {'shape': 'oval', 'density': 'medium', 'leaf_size': 'small', 'flowering': 'year_round', 'berry_type': 'purple', 'thorns': 'none'}")
