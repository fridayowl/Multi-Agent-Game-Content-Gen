...
# Style Parameters: {'shape': 'rounded', 'surface': 'mossy', 'size_category': 'medium', 'formation': 'single', 'weathering': 'fresh', 'mineral_type': 'limestone'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_031916_medivial_game/ai_creative_assets/ai_textures/stone_medieval_469f92ba.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.0048996316194354
WIDTH_MULT = 0.8735653600693747
COMPLEXITY = "medium"
DETAIL_COUNT = 6
ASYMMETRY = 0.198010736173647
...
try:
    ...
    print(f"🎨 Style: {'shape': 'rounded', 'surface': 'mossy', 'size_category': 'medium', 'formation': 'single', 'weathering': 'fresh', 'mineral_type': 'limestone'}")
