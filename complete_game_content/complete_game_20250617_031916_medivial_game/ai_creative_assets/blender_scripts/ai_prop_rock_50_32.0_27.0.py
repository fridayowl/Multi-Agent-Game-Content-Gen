...
# Style Parameters: {'shape': 'crystalline', 'surface': 'cracked', 'size_category': 'small', 'formation': 'outcrop', 'weathering': 'fresh', 'mineral_type': 'granite'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_031916_medivial_game/ai_creative_assets/ai_textures/stone_medieval_1c4e6994.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.8540918145162106
WIDTH_MULT = 1.281343584336636
COMPLEXITY = "simple"
DETAIL_COUNT = 3
ASYMMETRY = 0.14139466325967143
...
def create_ai_rock():
    ...
    rock.name = f"AI_crystalline_rock_50"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_crystalline_bush_50"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'crystalline', 'surface': 'cracked', 'size_category': 'small', 'formation': 'outcrop', 'weathering': 'fresh', 'mineral_type': 'granite'}")
