...
# Style Parameters: {'shape': 'crystalline', 'surface': 'cracked', 'size_category': 'boulder', 'formation': 'pile', 'weathering': 'eroded', 'mineral_type': 'basalt'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_104038_medivial_game/ai_creative_assets/ai_textures/stone_medieval_50cd7ffd.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.6718028688473672
WIDTH_MULT = 1.1289549562137573
COMPLEXITY = "simple"
DETAIL_COUNT = 4
ASYMMETRY = 0.299329757664261
...
def create_ai_tree():
    ...
    if trunk_style == "twisted":
        ...
        for i in range(max(2, DETAIL_COUNT // 2)):
            ...
            bpy.ops.mesh.primitive_cylinder_add(
                ...
                location=(34.0, 3.0, i * segment_height + segment_height/2)
            )
        ...
        bpy.ops.mesh.primitive_cylinder_add(
            ...
            location=(34.0, 3.0, trunk_height * 0.4)
        )
        ...
        bpy.ops.mesh.primitive_cylinder_add(
            ...
            location=(34.0, 3.0, trunk_height * 0.3)
        )
        trunk = bpy.context.active_object
        ...
        for i in range(2):
            ...
            bpy.ops.mesh.primitive_cylinder_add(
                ...
                location=(34.0 + offset_x, 3.0 + offset_y, trunk_height * 0.75)
            )
        ...
        bpy.ops.mesh.primitive_cylinder_add(
            ...
            radius=trunk_radius,
            depth=trunk_height,
            location=(34.0, 3.0, trunk_height/2)
        )
        trunk = bpy.context.active_object
    ...
    if canopy_shape == "round":
        bpy.ops.mesh.primitive_ico_sphere_add(
            subdivisions=2,
            radius=canopy_size,
            location=(34.0, 3.0, canopy_height)
        )
        ...
        for i in range(DETAIL_COUNT):
            ...
            bpy.ops.mesh.primitive_ico_sphere_add(
                subdivisions=1,
                radius=size,
                location=(34.0 + offset_x, 3.0 + offset_y, canopy_height + offset_z)
            )
...
def create_ai_rock():
    ...
    if rock_shape == "angular":
        bpy.ops.mesh.primitive_cube_add(
            size=base_size,
            location=(34.0, 3.0, rock_height/2)
        )
        ...
        bpy.ops.mesh.primitive_cone_add(
            ...
            location=(34.0, 3.0, rock_height * 0.75)
        )
        rock = bpy.context.active_object
        ...
        for i in range(DETAIL_COUNT // 2):
            ...
            bpy.ops.mesh.primitive_cone_add(
                ...
                location=(34.0 + offset_x, 3.0 + offset_y, rock_height * 0.35)
            )
    ...
    rock.name = f"AI_crystalline_rock_10"
    ...
    if bush_shape == "spreading":
        ...
        for i in range(DETAIL_COUNT):
            ...
            bpy.ops.mesh.primitive_ico_sphere_add(
                subdivisions=1,
                radius=sphere_size,
                location=(34.0 + offset_x, 3.0 + offset_y, bush_height * 0.4)
            )
            sphere = bpy.context.active_object
        ...
        bpy.ops.mesh.primitive_ico_sphere_add(
            subdivisions=2,
            radius=bush_size,
            location=(34.0, 3.0, bush_height/2)
        )
        bush = bpy.context.active_object
        bush.scale = (1.0, 1.0, bush_height)
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_crystalline_bush_10"
...
def create_ai_well():
    ...
    bpy.ops.mesh.primitive_cylinder_add(
        ...
        location=(34.0, 3.0, 0.5 * HEIGHT_MULT)
    )
    ...
    if random.random() > 0.5:  # 50% chance of roof
        bpy.ops.mesh.primitive_cone_add(
            ...
            radius2=0.1,
            depth=0.8,
            location=(34.0, 3.0, HEIGHT_MULT + 0.4)
        )
...
try:
    ...
    print(f"🎨 Style: {'shape': 'crystalline', 'surface': 'cracked', 'size_category': 'boulder', 'formation': 'pile', 'weathering': 'eroded', 'mineral_type': 'basalt'}")
