...
# Style Parameters: {'shape': 'angular', 'surface': 'rough', 'size_category': 'small', 'formation': 'outcrop', 'weathering': 'weathered', 'mineral_type': 'sandstone'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_104038_medivial_game/ai_creative_assets/ai_textures/stone_medieval_4204caa6.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.9601081276230503
WIDTH_MULT = 0.805695595594245
COMPLEXITY = "simple"
DETAIL_COUNT = 3
ASYMMETRY = 0.3272323703740825
...
try:
    ...
    print(f"🎨 Style: {'shape': 'angular', 'surface': 'rough', 'size_category': 'small', 'formation': 'outcrop', 'weathering': 'weathered', 'mineral_type': 'sandstone'}")
