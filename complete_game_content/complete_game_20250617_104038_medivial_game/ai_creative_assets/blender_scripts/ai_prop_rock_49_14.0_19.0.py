...
# Style Parameters: {'shape': 'angular', 'surface': 'rough', 'size_category': 'boulder', 'formation': 'single', 'weathering': 'ancient', 'mineral_type': 'basalt'}
...
# AI Texture paths
ai_textures = {"surface": "complete_game_content/complete_game_20250617_104038_medivial_game/ai_creative_assets/ai_textures/stone_medieval_a3692af3.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 0.947846612015466
WIDTH_MULT = 1.2800751659471772
COMPLEXITY = "medium"
DETAIL_COUNT = 5
ASYMMETRY = 0.3437471496844272
...
def create_ai_rock():
    ...
    rock.name = f"AI_angular_rock_49"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_angular_bush_49"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'angular', 'surface': 'rough', 'size_category': 'boulder', 'formation': 'single', 'weathering': 'ancient', 'mineral_type': 'basalt'}")
