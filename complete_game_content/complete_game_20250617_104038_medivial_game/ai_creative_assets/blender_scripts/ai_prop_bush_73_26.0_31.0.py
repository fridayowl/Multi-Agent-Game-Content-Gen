...
# Style Parameters: {'shape': 'spreading', 'density': 'medium', 'leaf_size': 'large', 'flowering': 'none', 'berry_type': 'blue', 'thorns': 'none'}
...
# AI Texture paths
ai_textures = {"foliage": "complete_game_content/complete_game_20250617_104038_medivial_game/ai_creative_assets/ai_textures/foliage_medieval_c6f42c97.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.2746505508073533
WIDTH_MULT = 0.9220482969432588
COMPLEXITY = "simple"
DETAIL_COUNT = 3
ASYMMETRY = 0.1467368989697683
...
def create_ai_rock():
    ...
    rock.name = f"AI_spreading_rock_73"
...
def create_ai_bush():
    ...
    if bush_shape == "spreading":
        ...
        bpy.ops.object.transform_apply(scale=True)
        bush.name = f"AI_spreading_bush_73"
...
try:
    ...
    print(f"🎨 Style: {'shape': 'spreading', 'density': 'medium', 'leaf_size': 'large', 'flowering': 'none', 'berry_type': 'blue', 'thorns': 'none'}")
