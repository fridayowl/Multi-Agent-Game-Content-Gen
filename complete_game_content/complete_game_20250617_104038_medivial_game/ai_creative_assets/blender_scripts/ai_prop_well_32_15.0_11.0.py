...
# Style Parameters: {'construction': 'metal', 'roof_style': 'none', 'bucket_system': 'rope', 'water_level': 'high', 'decoration': 'plain', 'age': 'new'}
...
# AI Texture paths
ai_textures = {"stone": "complete_game_content/complete_game_20250617_104038_medivial_game/ai_creative_assets/ai_textures/stone_medieval_4fb23ffe.png"}

# AI-Generated Geometry Parameters
HEIGHT_MULT = 1.219100677368362
WIDTH_MULT = 0.9056839445248579
COMPLEXITY = "complex"
DETAIL_COUNT = 3
ASYMMETRY = 0.23997825313811363
...
try:
    ...
    print(f"🎨 Style: {'construction': 'metal', 'roof_style': 'none', 'bucket_system': 'rope', 'water_level': 'high', 'decoration': 'plain', 'age': 'new'}")
